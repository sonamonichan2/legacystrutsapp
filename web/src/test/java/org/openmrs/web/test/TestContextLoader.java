...
/**
 * The only reason why i created this class is to be able to create an
 * application context which can be refreshed multiple times, unlike the default
 * GenericApplicationContext which can be refreshed only once. This class is
 * used for @ContextConfiguration in WebModuleActivatorTest
 */
