...
public class UpdateFilterTest extends BaseWebContextSensitiveTest {
	...
	public void authenticateAsSuperUser_shouldReturnFalseIfGivenInvalidCredentials()
			throws Exception {
		Assert.assertFalse(new UpdateFilter().authenticateAsSuperUser(
				"a-bad-username", "a-bad-password"));
	}
	...
	public void authenticateAsSuperUser_shouldReturnFalseIfGivenUserIsNotSuperuser()
			throws Exception {
		// can switch to using "butch" in standardDataSet once we know bruno's
		// password
	...
	public void authenticateAsSuperUser_shouldReturnTrueIfGivenUserIsSuperuser()
			throws Exception {
		Assert.assertTrue(new UpdateFilter().authenticateAsSuperUser("admin",
				"test"));
	}
	...
	public void isSuperUser_shouldReturnTrueIfGivenUserHasSuperuserRole()
			throws Exception {
	...
	public void isSuperUser_shouldReturnFalseIfGivenUserDoesNotHaveTheSuperUserRole()
			throws Exception {
