 ...
 * framework-specific classes) will be encoded as JSON. If the model contains
 * only one key, you can have it extracted encoded as JSON alone via
...
public class MappingJacksonJsonView extends AbstractView {
	...
	/**
	 * Construct a new {@code MappingJacksonJsonView}, setting the content type
	 ...
	 * further control of the JSON serialization process. The other option is to
	 * use Jackson's provided annotations on the types to be serialized, in
	...
	/**
	 * Whether to use the default pretty printer when writing JSON. This is a
	...
	protected void renderMergedOutputModel(Map<String, Object> model,
		...
		OutputStream stream = (this.updateContentLength
	 ...
	 *            {@link #filterModel}
	 * @param jsonPrefix
	 *            the prefix for this view's JSON output (as indicated through
	 *            {@link #setJsonPrefix}/{@link #setPrefixJson})
	 * @throws IOException
	 *             if writing failed
	 */
