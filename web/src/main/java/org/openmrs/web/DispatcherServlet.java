 ...
 * webApplicationContext is refreshed, the DispatcherServlet needs to be
 * refreshed too.
 * 
...
public class DispatcherServlet
	...
	protected void initFrameworkServlet() throws ServletException,
			BeansException {
		// refresh the application context to look for module xml config files
		// as well
	...
	/**
	 * Called by the ModuleUtil after adding in a new module. This needs to be
	 * called because the new mappings and advice that a new module adds in are
	 * cached by Spring's DispatcherServlet. This method will reload that cache.
	 * 
	...
	/**
	 * Stops and closes the application context created by this dispatcher
	 * servlet.
	 */
	public void stopAndCloseApplicationContext() {
		try {
			...
			log.error(
					"Exception while stopping and closing dispatcherServlet context: ",
					e);
		}
	}
}
