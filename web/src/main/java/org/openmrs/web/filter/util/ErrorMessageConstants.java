...
/**
 * This class contains all constants that describes names of properties, which
 * are used as keys, when showing localized error messages on pages of install
 * and databtase wizard
 */
