...
/**
 * The {@link UpdateFilter} uses this model object to hold all properties that
 * are edited by the user in the wizard. All attributes on this model object are
 * added to all templates rendered by the {@link StartupFilter}.
 */
public class UpdateFilterModel {
	...
	/**
	 * Convenience method that reads from liquibase again to get the most recent
	 * list of changesets that still need to be run.
	 */
