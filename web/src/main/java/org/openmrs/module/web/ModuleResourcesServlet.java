...
public class ModuleResourcesServlet extends HttpServlet {
	...
	protected File getFile(HttpServletRequest request) {
		...
		String realPath = getServletContext().getRealPath("") + MODULE_PATH
				+ module.getModuleIdAsPath() + "/resources" + relativePath;
		...
		if (devDir != null) {
			realPath = devDir.getAbsolutePath()
		...
		if (!f.exists()) {
			log.warn("No file with path '" + realPath + "' exists for module '"
					+ module.getModuleId() + "'");
			return null;
		}
