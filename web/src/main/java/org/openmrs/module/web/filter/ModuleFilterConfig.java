...
/**
 * This class is an implementation of FilterConfig for use in instantiating
...
public class ModuleFilterConfig implements FilterConfig {
	 ...
	 */
	private ModuleFilterConfig(ModuleFilterDefinition filterDefinition,
	 ...
	 * @param servletContext
	 *            The {@link ServletContext} to store in this ModuleFilterConfig
	 * @return The ModuleFilterConfig that is fully initialized with the passed
	 *         parameters
	 */
	public static ModuleFilterConfig getInstance(
			ModuleFilterDefinition filterDefinition,
			ServletContext servletContext) {
	...
	public Enumeration<String> getInitParameterNames() {
		Vector<String> v = new Vector<String>(filterDefinition
