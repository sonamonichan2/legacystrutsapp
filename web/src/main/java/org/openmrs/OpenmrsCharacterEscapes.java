...
/**
 * An instance of this class can be passed to an ObjectMapper instance when
 * serializing objects to JSON using the jackson API so as to escape html and
 * scripts inside html tags
 */
