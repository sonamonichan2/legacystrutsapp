...
public class BaseCustomizableMetadataTest extends BaseContextSensitiveTest {
	...
	/**
	 * @verifies void the attribute if an attribute with same attribute type
	...
	public void setAttribute_shouldVoidTheAttributeIfAnAttributeWithSameAttributeTypeAlreadyExistsAndTheMaxOccursIsSetTo1()
		...
		ProviderAttribute lastAttribute = (ProviderAttribute) provider
				.getAttributes().toArray()[0];
		Assert.assertTrue(lastAttribute.getVoided());
	}

	/**
	 * @verifies work for attributes with datatypes whose values are stored in
	 *           other tables
	 * @see org.openmrs.BaseCustomizableMetadata#setAttribute(org.openmrs.attribute.Attribute)
	 */
	@Test
	public void setAttribute_shouldWorkForAttriubutesWithDatatypesWhoseValuesAreStoredInOtherTables()
		...
		provider.setAttribute(buildProviderAttribute(cv,
				"Worked lots of places..."));
	...
	private ProviderAttribute buildProviderAttribute(
			ProviderAttributeType providerAttributeType, Object value)
			throws Exception {
