...
public class OpenmrsProfileExcludeFilterTest extends BaseContextSensitiveTest {
	 ...
	 * @see OpenmrsProfileExcludeFilter#match(org.springframework.core.type.classreading.MetadataReader,
	...
	public void match_shouldIncludeBeanForOpenmrs1_10AndLater()
			throws Exception {
		OpenmrsProfile1_10 bean = applicationContext
				.getBean(OpenmrsProfile1_10.class);
	...
	public void match_shouldIncludeBeanForOpenmrs1_8AndLater() throws Exception {
		OpenmrsProfile1_8 bean = applicationContext
				.getBean(OpenmrsProfile1_8.class);
