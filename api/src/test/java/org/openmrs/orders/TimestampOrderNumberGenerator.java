...
/**
 * An OrderNumberGenerator used for testing purposes, returns the order number
 * set as a context attribute otherwise returns one matching the current time
 * stamp and prepends a prefix to it
 */
...
public class TimestampOrderNumberGenerator implements OrderNumberGenerator {
	...
	public String getNewOrderNumber(OrderContext orderContext) {
		...
		if (orderContext != null) {
			nextOrderNumber = (String) orderContext
					.getAttribute(NEXT_ORDER_NUMBER);
		}
