...
public class TimerSchedulerServiceImplTest extends BaseContextSensitiveTest {
	...
	/**
	 * Tests whether the TimerScheduler schedules tasks even if the
	 * repeatInterval is zero.
	 * 
	...
	public void scheduleTask_shouldHandleZeroRepeatInterval() throws Exception {
		...
		// without this commit there seems to be a table lock left on the
		// SCHEDULER_TASK_CONFIG table, see TRUNK-4212
		Context.flushSession();

		// Assert that the clientTask is not null, i.e. the sheduleTask was able
		// to successfully schedule in case of zero repeatInterval.
		assertNotNull(
