...
public class HttpUrlTest {
	...
	@Test
	public void constructor_shouldNotThrowExceptionIfItIsAnHttpUrl()
			throws Exception {
	...
	@Test
	public void constructor_shouldThrowMalformedUrlExceptionIfTheUrlDoesNotHaveHttp()
			throws Exception {
	...
	public void toString_shouldReturnUrl() throws Exception {
		assertThat(new HttpUrl("http://something").toString(),
				is("http://something"));
	}
}
