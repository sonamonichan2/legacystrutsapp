...
public class ProviderByPersonNameComparatorTest {
	...
	/**
	 * @see PersonByNameComparator#comparePersonsByName(org.openmrs.Person,
	 *      org.openmrs.Person)
	 */
	@Test
	public void compareProvidersByPersonsName_shouldReturnNegativeIfPersonNameForProvider1ComesBeforeThatOfProvider2()
		...
		int actualValue = new ProviderByPersonNameComparator().compare(
				provider1, provider2);
		Assert.assertTrue("Expected a negative value but it was: "
	...
	public void compareProvidersByPersonName_shouldReturnPositiveIfPersonNameForProvider1ComesAfterThatOfProvider2()
		...
		int actualValue = new ProviderByPersonNameComparator().compare(
				provider1, provider2);
		Assert.assertTrue("Expected a positive value but it was: "
				+ actualValue, actualValue > 0);
	}
	...
	public void compareProvidersByPersonName_shouldReturnZeroIfTheGivenNameMiddleNameAndFamilyNameMatch()
		...
		int actualValue = new ProviderByPersonNameComparator().compare(
				provider1, provider2);
		Assert.assertTrue("Expected zero but it was: " + actualValue,
				actualValue == 0);
	}
