...
/**
 * Tests methods on the {@link DatabaseUpdater} class. This class expects
 * /metadata/model to be on the classpath so that the
 * liquibase-update-to-latest.xml can be found.
 */
public class DatabaseUpdaterTest extends BaseContextSensitiveTest {
	...
	public void updatesRequired_shouldAlwaysHaveAValidUpdateToLatestFile()
			throws Exception {
		...
		// does not run DatabaseUpdater.update() because hsqldb doesn't like
