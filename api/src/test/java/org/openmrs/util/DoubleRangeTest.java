...
public class DoubleRangeTest {
	...
	/**
	 * @verifies return plus one if both lows are equal but other high is
	 *           greater than this high
	 * @see DoubleRange#compareTo(DoubleRange)
	 */
	@Test
	...
	/**
	 * @verifies return minus one if both lows are equal but other high is less
	 *           than this high
	 * @see DoubleRange#compareTo(DoubleRange)
	 */
	@Test
	...
	public void toString_shouldPrintEmptyStringIfLowAndHighAreInfinite()
			throws Exception {
		DoubleRange r1 = new DoubleRange(Double.NEGATIVE_INFINITY,
				Double.POSITIVE_INFINITY);
		assertEquals("", r1.toString());
	}

	/**
	 * @verifies return the same hashCode for objects representing the same
	 *           interval
