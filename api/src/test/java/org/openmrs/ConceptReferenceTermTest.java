...
public class ConceptReferenceTermTest {
	...
	public void addConceptReferenceTermMap_shouldSetTermAAsTheTermToWhichAMappingIsBeingAdded()
		...
		term.addConceptReferenceTermMap(new ConceptReferenceTermMap(
				new ConceptReferenceTerm(1), new ConceptMapType(1)));
		Assert.assertEquals(
				true,
				term.equals(term.getConceptReferenceTermMaps().iterator()
						.next().getTermA()));
	}
	...
	public void addConceptReferenceTermMap_shouldNotAddAMapWhereTermBIsItself()
		...
		term.addConceptReferenceTermMap(new ConceptReferenceTermMap(term,
				new ConceptMapType(1)));
