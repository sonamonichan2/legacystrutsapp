...
@StartModule({"org/openmrs/module/include/dssmodule-1.44.omod",
		"org/openmrs/module/include/atdproducer-0.51.omod"})
public class StartModuleAnnotatioTest extends BaseModuleContextSensitiveTest {
	...
	public void shouldStartModules() throws Exception {
		...
		Class<?> atdServiceClass = Context
				.loadClass("org.openmrs.module.atdproducer.service.ATDService");
		Class<?> dssServiceClass = Context
				.loadClass("org.openmrs.module.dssmodule.DssService");
