...
public class LuhnIdentifierValidatorTest {
	...
	private String[] allowedIdentifiers = {"a", "123456", "ab32kcdak3",
			"chaseisreallycoolyay", "1", "moose", "MOOSE", "MooSE",
			"adD3Eddf429daD999"};

	private char[] allowedIdentifiersCheckDigits = {'D', 'G', 'J', 'H', 'I',
			'H', 'H', 'H', 'B'};
	...
	private int[] allowedIdentifiersCheckDigitsInts = {3, 6, 9, 7, 8, 7, 7, 7,
			1};
