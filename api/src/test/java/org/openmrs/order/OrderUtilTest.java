...
public class OrderUtilTest {
	...
	public static boolean isActiveOrder(Order order, Date asOfDate) {
		return order.isActive(asOfDate)
				&& order.getAction() != Order.Action.DISCONTINUE;
	}
	...
	/**
	 * @verifies false if orderType2 is neither the same nor a subtype of
	 *           orderType1
	 * @see OrderUtil#isType(org.openmrs.OrderType, org.openmrs.OrderType)
	 */
	@Test
	...
	public void checkScheduleOverlap_shouldReturnTrueIfOrder1AndOrder2DoNotHaveEndDate()
		...
		order1.setScheduledDate(DateUtils.addDays(date, 4)); // Order1 scheduled
																// after 4 days
																// without stop
																// date
		...
		order2.setScheduledDate(DateUtils.addDays(date, 6)); // Order2 scheduled
																// after 6 days
																// without stop
																// date
		...
		assertTrue(OrderUtil.checkScheduleOverlap(order2, order1)); // Checks
																	// vice
																	// versa
	}
	...
	public void checkScheduleOverlap_shouldReturnTrueIfOrder1AndOrder2HaveSameStartDates()
		...
		order1.setScheduledDate(DateUtils.addDays(date, 6)); // Order1 scheduled
																// after 6 days
		order1.setUrgency(Order.Urgency.ON_SCHEDULED_DATE);

		Order order2 = new Order();
		order2.setDateActivated(date);
		order2.setScheduledDate(DateUtils.addDays(date, 6)); // Order2 also
																// scheduled
																// after 6 days
		order2.setUrgency(Order.Urgency.ON_SCHEDULED_DATE);
	...
	/**
	 * @verifies return false if order1 ends before order2 starts Checks vice
	 *           versa
	 * @see OrderUtil#checkScheduleOverlap(Order,Order)
	 */
	@Test
	public void checkScheduleOverlap_shouldReturnFalseIfOrder1EndsBeforeOrder2Starts()
		...
		Order order1 = new Order();
		order1.setDateActivated(date);
		order1.setAutoExpireDate(DateUtils.addDays(date, 2)); // Order1 getting
																// expired after
																// 2 days

		Order order2 = new Order();
		order2.setDateActivated(date);
		order2.setScheduledDate(DateUtils.addDays(date, 4)); // Order2 scheduled
																// after 4 days
		order2.setUrgency(Order.Urgency.ON_SCHEDULED_DATE);
	...
	public void checkScheduleOverlap_shouldReturnFalseIfOrder1StartsAfterOrder2()
		...
		Date date = new Date();
		Order order1 = new Order();
		order1.setScheduledDate(DateUtils.addDays(date, 11)); // Order1 getting
																// started after
																// existing
																// order's stop
		order1.setUrgency(Order.Urgency.ON_SCHEDULED_DATE);
		...
		Order order2 = new Order();
		order2.setDateActivated(date);
		order2.setAutoExpireDate(DateUtils.addDays(date, 2)); // Order2 expiring
																// after 2 days
	...
	/**
	 * @verifies return true if order1 stops after the order2 has already been
	 *           activated Checks vice versa
	 * @see OrderUtil#checkScheduleOverlap(Order,Order)
	 */
	@Test
	public void checkScheduleOverlap_shouldReturnTrueIfOrder1StopsAfterTheOrder2HasAlreadyBeenActivated()
		...
		Date date = new Date();
		Order order1 = new Order();
		order1.setDateActivated(date); // Order1 scheduled today getting expired
										// after 5 days
	...
	public void checkScheduleOverlap_shouldReturnTrueIfOrder1StartsWhenTheOrder2IsActive()
		...
		Date date = new Date();
		Order order1 = new Order();
		order1.setScheduledDate(DateUtils.addDays(date, 3)); // Order1 scheduled
																// after 3 days
		order1.setUrgency(Order.Urgency.ON_SCHEDULED_DATE);

		Order order2 = new Order();
		order2.setDateActivated(date); // Order2 scheduled today getting expired
										// after 4 days
	...
	/**
	 * @verifies return true if order1 starts before order2 and ends after
	 *           order2
	 * @see OrderUtil#checkScheduleOverlap(Order,Order)
	 */
	@Test
	...
	/**
	 * @verifies return true if order2 starts before order1 and ends after
	 *           order1
	 * @see OrderUtil#checkScheduleOverlap(org.openmrs.Order, org.openmrs.Order)
	 */
	@Test
	public void checkScheduleOverlap_shouldReturnTrueIfOrder2StartsBeforeOrder1AndEndsAfterOrder1()
			throws Exception {
	 ...
	 */
	@Test
	public void checkScheduleOverlap_shouldReturnTrueIfOrder1StartsOnTheStopDateOfOrder2()
			throws Exception {
		DateFormat df = new SimpleDateFormat("dd/MM/yyy");
		Order order1 = new Order();
	 ...
	 */
	@Test
	public void checkScheduleOverlap_shouldReturnTrueIfOrder1EndsOnTheStartDateOfOrder2()
			throws Exception {
		DateFormat df = new SimpleDateFormat("dd/MM/yyy");
		Order order1 = new Order();
	 ...
	 */
	@Test
	public void checkScheduleOverlap_shouldReturnTrueIfBothOrdersStartAndEndOnSameDates()
			throws Exception {
		DateFormat df = new SimpleDateFormat("dd/MM/yyy");
		Order order1 = new Order();
		order1.setDateActivated(df.parse("05/08/2014"));
