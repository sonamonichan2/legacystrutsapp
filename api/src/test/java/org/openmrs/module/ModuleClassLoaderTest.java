...
public class ModuleClassLoaderTest extends BaseContextSensitiveTest {
	...
	@Before
	public void before() {
		mockModule = new Module("mockmodule", "mockmodule",
				"org.openmrs.module.mockmodule", "author", "description", "1.0");
		mockModules = new HashMap<String, String>();
	}

	/**
	 * @verifies return true if file matches and openmrs version matches
	 * @see ModuleClassLoader#shouldResourceBeIncluded(Module, java.net.URL,
	...
	public void shouldResourceBeIncluded_shouldReturnTrueIfFileMatchesAndOpenmrsVersionMatches()
		...
		boolean result = ModuleClassLoader.shouldResourceBeIncluded(
				mockModule,
				URI.create(
						"file://module/mockmodule/lib/mockmodule-api-1.10.jar")
						.toURL(), "1.10.0-SNAPSHOT", mockModules);
	...
	public void shouldResourceBeIncluded_shouldReturnFalseIfFileMatchesButOpenmrsVersionDoesNot()
		...
		boolean result = ModuleClassLoader.shouldResourceBeIncluded(
				...
				URI.create(
						"file://module/mockmodule/lib/mockmodule-api-1.10.jar")
						.toURL(), "1.12.0-SNAPSHOT", mockModules);

		assertThat(result, is(false));
	}

	/**
	 * @verifies return true if file does not match and openmrs version does not
	 *           match
	 * @see ModuleClassLoader#shouldResourceBeIncluded(Module, java.net.URL,
	 *      String, java.util.Map)
	 */
	...
	public void shouldResourceBeIncluded_shouldReturnTrueIfFileDoesNotMatchAndOpenmrsVersionDoesNotMatch()
		...
		boolean result = ModuleClassLoader.shouldResourceBeIncluded(
				...
				URI.create(
						"file://module/mockmodule/lib/mockmodule-api-1.10.jar")
						.toURL(), "1.9.8-SNAPSHOT", mockModules);
	...
	/**
	 * @verifies return false if file matches and openmrs version matches but
	 ...
	 */
	@Test
	public void shouldResourceBeIncluded_shouldReturnFalseIfFileMatchesAndModuleNotFound()
			throws Exception {
		ModuleConditionalResource resource = new ModuleConditionalResource();
		resource.setPath("lib/mockmodule-api-1.10.jar");
	...
	/**
	 * @verifies return true if file does not match and module version does not
	 *           match
	 * @see ModuleClassLoader#shouldResourceBeIncluded(Module, java.net.URL,
	 *      String, java.util.Map)
	 */
