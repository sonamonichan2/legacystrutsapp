...
public class ModuleUtilIT extends BaseContextSensitiveTest {
	...
	public void getURLStream_shouldReturnAValidInputStreamForOldModuleUrls()
			throws Exception {
		ModuleUtil
				.getURLStream(new URL(
						"https://dev.openmrs.org/modules/download/formentry/update.rdf"));
	}
	...
	public void getURL_shouldReturnAnUpdateRdfPageForOldHttpsDevUrls()
			throws Exception {
		String url = "https://dev.openmrs.org/modules/download/formentry/update.rdf";
		String updateRdf = ModuleUtil.getURL(new URL(url));
		Assert.assertTrue("Unable to fetch module update url: " + url,
				updateRdf.contains("<updates"));
	}
	...
	public void getURL_shouldReturnAnUpdateRdfPageForOldHttpsModuleUrls()
			throws Exception {
	...
	public void getURL_shouldReturnAnUpdateRdfPageForModuleUrls()
			throws Exception {
	...
	public void getMandatoryModules_shouldReturnMandatoryModuleIds()
		...
		Assert.assertEquals("firstmodule", ModuleUtil.getMandatoryModules()
				.get(0));
	}
	...
	public void matchRequiredVersions_shouldAllowRangedRequiredVersion()
		...
		Assert.assertTrue(ModuleUtil.matchRequiredVersions(openmrsVersion,
				requiredOpenmrsVersion));
	}
	...
	public void matchRequiredVersions_shouldReturnFalseWhenOpenmrsVersionBeyondWildCardRange()
		...
		Assert.assertFalse(ModuleUtil.matchRequiredVersions(openmrsVersion,
				requiredOpenmrsVersion));
	...
	public void getPathForResource_shouldHandleUiSpringmvcCssUiDotCssExample()
		...
		Assert.assertEquals("/css/ui.css",
				ModuleUtil.getPathForResource(module, path));
	}
	...
	public void getModuleRepository_shouldUseTheRuntimePropertyAsTheFirstChoiceIfSpecified()
		...
		runtimeProperties.setProperty(
				ModuleConstants.REPOSITORY_FOLDER_RUNTIME_PROPERTY, folderName);
		try {
	...
	public void getModuleRepository_shouldReturnTheCorrectFileIfTheRuntimePropertyIsAnAbsolutePath()
			throws Exception {
		final File expectedModuleRepo = new File(
				System.getProperty("java.io.tmpdir"), "test_folder");
		expectedModuleRepo.mkdirs();

		runtimeProperties.setProperty(
				ModuleConstants.REPOSITORY_FOLDER_RUNTIME_PROPERTY,
				expectedModuleRepo.getAbsolutePath());
		try {
