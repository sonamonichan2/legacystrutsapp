...
public class HL7UtilTest {
	...
	public void parseHL7Timestamp_shouldNotFlubDstWith20091225123000()
			throws Exception {
		// set tz to be US/Indianapolis so this junit test works everywhere and
		// always
		...
		// + new SimpleDateFormat("Z").format(new
		// SimpleDateFormat("yyyyMMdd").parse("20091225")));
		// System.out.println("tz for a date in dst: "
		// + new SimpleDateFormat("Z").format(new
		// SimpleDateFormat("yyyyMMdd").parse("20090625")));
	...
	public void parseHL7Timestamp_shouldHandle197804110615dash0200()
			throws Exception {
	...
	public void getTimeZoneOffset_shouldReturnTimezoneForGivenDateAndNotTheCurrentDate()
			throws Exception {
		// set tz to be US/Indianapolis so this junit test works everywhere and
		// always
		TimeZone originalTimeZone = TimeZone.getDefault();
		...
		Assert.assertEquals("-0500", HL7Util.getTimeZoneOffset("197804110615",
				new SimpleDateFormat("yyyyMMdd").parse("20091225")));
	...
	public void getTimeZoneOffset_shouldReturnTimezoneStringIfExistsInGivenString()
		...
		Assert.assertEquals("+1100",
				HL7Util.getTimeZoneOffset("348934934934+1100", new Date()));
	}
	...
	public void parseHL7Time_shouldHandle0615() throws Exception {
		// set tz to be a __non DST__ timezone so this junit test works
