...
public class HL7ServiceTest extends BaseContextSensitiveTest {
	...
	public void processHL7InQueue_shouldCreateHL7InArchiveAfterSuccessfulParsing()
			throws Exception {
		...
		// set a global property for the archives directory as a temporary
		// folder
	...
	public void processHL7InQueue_shouldCreateHL7InErrorAfterFailedParsing()
			throws Exception {
		executeDataSet("org/openmrs/hl7/include/ORUTest-initialData.xml");
	...
	public void processHL7InQueue_shouldFailIfGivenInQueueIsAlreadyMarkedAsProcessing()
			throws Exception {
		executeDataSet("org/openmrs/hl7/include/ORUTest-initialData.xml");

		HL7Service hl7service = Context.getHL7Service();
		HL7InQueue queueItem = hl7service.getHL7InQueue(1);
		queueItem.setMessageState(HL7Constants.HL7_STATUS_PROCESSING); // set
																		// this
																		// to
																		// processing
		hl7service.processHL7InQueue(queueItem);
	...
	public void processHL7Message_shouldSaveHl7MessageToTheDatabase()
			throws Exception {
		executeDataSet("org/openmrs/hl7/include/ORUTest-initialData.xml");
		HL7Service hl7service = Context.getHL7Service();
		...
		List<Obs> returnVisitDateObsForPatient3 = Context.getObsService()
				.getObservationsByPersonAndConcept(new Patient(3),
	...
	public void parseHL7String_shouldParseTheGivenStringIntoMessage()
			throws Exception {
		HL7Service hl7service = Context.getHL7Service();
		Message message = hl7service
				.parseHL7String("MSH|^~\\&|FORMENTRY|AMRS.ELD|HL7LISTENER|AMRS.ELD|20080226102656||ORU^R01|JqnfhKKtouEz8kzTk6Zo|P|2.5|1||||||||16^AMRS.ELD.FORMID\r"
	...
	public void processHL7Message_shouldParseMessageTypeSuppliedByModule()
			throws Exception {
		...
		// the above module provides a handler for messages of type "ADR" with
		// trigger "A19"

		ModuleUtil.startup(props);

		// the application context cannot restart here to load in the
		// moduleApplicationContext that
		// calls the setHL7Handlers method so we're doing it manually here
		Class<Application> c = (Class<Application>) Context
				.loadClass("org.openmrs.module.examplehl7handlers.ADRHandler");
		...
		try {
			...
			if (e.getCause() != null)
				Assert.assertEquals("In ADR A19 parser", e.getCause()
						.getMessage());
			else {
	...
	public void processHL7InQueue_shouldParseOruR01MessageUsingOverriddenParserProvidedByAModule()
			throws Exception {
		executeDataSet("org/openmrs/hl7/include/ORUTest-initialData.xml");
		...
		HL7InError error = errors.get(errors.size() - 1); // get the last error,
															// the one made by
															// this test
															// presumably
		Assert.assertTrue(error.getErrorDetails().contains(
				"In alternate oru r01 parser"));
	...
	public void resolvePersonFromIdentifiers_shouldFindAPersonBasedOnAPatientIdentifier()
			throws Exception {
		executeDataSet("org/openmrs/hl7/include/ORUTest-initialData.xml");
		HL7Service hl7service = Context.getHL7Service();
		Message message = hl7service
		...
		Person result = hl7service.resolvePersonFromIdentifiers(nk1List.get(0)
				.getNextOfKinAssociatedPartySIdentifiers());
		Assert.assertNotNull("should have found a person", result);
		Assert.assertEquals("found the wrong person", 2, result.getId()
				.intValue());
	}
	...
	public void resolvePersonFromIdentifiers_shouldFindAPersonBasedOnAUUID()
			throws Exception {
		executeDataSet("org/openmrs/hl7/include/ORUTest-initialData.xml");
		HL7Service hl7service = Context.getHL7Service();
		Message message = hl7service
	...
	public void resolvePersonFromIdentifiers_shouldFindAPersonBasedOnTheInternalPersonID()
			throws Exception {
		executeDataSet("org/openmrs/hl7/include/ORUTest-initialData.xml");
		HL7Service hl7service = Context.getHL7Service();
		Message message = hl7service
	...
	public void resolvePersonFromIdentifiers_shouldReturnNullIfNoPersonIsFound()
			throws Exception {
		executeDataSet("org/openmrs/hl7/include/ORUTest-initialData.xml");
		HL7Service hl7service = Context.getHL7Service();
		Message message = hl7service
	...
	public void getPersonFromNK1_shouldFailIfAPersonWithTheSameUUIDExists()
			throws Exception {
		executeDataSet("org/openmrs/hl7/include/ORUTest-initialData.xml");
		HL7Service hl7service = Context.getHL7Service();
		Message message = hl7service
	...
	public void getPersonFromNK1_shouldFailIfNoBirthdateSpecified()
			throws Exception {
		HL7Service hl7service = Context.getHL7Service();
		Message message = hl7service
				.parseHL7String("MSH|^~\\&|FORMENTRY|AMRS.ELD|HL7LISTENER|AMRS.ELD|20080226102656||ORU^R01|JqnfhKKtouEz8kzTk6Zo|P|2.5|1||||||||16^AMRS.ELD.FORMID\r"
	...
	public void getPersonFromNK1_shouldFailIfNoGenderSpecified()
			throws Exception {
		HL7Service hl7service = Context.getHL7Service();
		Message message = hl7service
				.parseHL7String("MSH|^~\\&|FORMENTRY|AMRS.ELD|HL7LISTENER|AMRS.ELD|20080226102656||ORU^R01|JqnfhKKtouEz8kzTk6Zo|P|2.5|1||||||||16^AMRS.ELD.FORMID\r"
	...
	public void getPersonFromNK1_shouldReturnASavedNewPerson() throws Exception {
		...
		Assert.assertNotNull("the person should exist", Context
				.getPersonService().getPersonByUuid(result.getUuid()));
	}
	...
	public void getPersonFromNK1_shouldReturnAPatientIfValidPatientIdentifiersExist()
			throws Exception {
		executeDataSet("org/openmrs/hl7/include/ORUTest-initialData.xml");
		HL7Service hl7service = Context.getHL7Service();
		Message message = hl7service
		...
		Assert.assertTrue("should have returned a Patient",
	...
	public void getUuidFromIdentifiers_shouldFindAUUIDInAnyPositionOfTheArray()
			throws Exception {
	...
	public void getUuidFromIdentifiers_shouldReturnNullIfNoUUIDFound()
			throws Exception {
		HL7Service hl7service = Context.getHL7Service();
		Message message = hl7service
				.parseHL7String("MSH|^~\\&|FORMENTRY|AMRS.ELD|HL7LISTENER|AMRS.ELD|20080226102656||ORU^R01|JqnfhKKtouEz8kzTk6Zo|P|2.5|1||||||||16^AMRS.ELD.FORMID\r"
	...
	public void getUuidFromIdentifiers_shouldNotFailIfMultipleSimilarUUIDsExistInIdentifiers()
			throws Exception {
		HL7Service hl7service = Context.getHL7Service();
		Message message = hl7service
				.parseHL7String("MSH|^~\\&|FORMENTRY|AMRS.ELD|HL7LISTENER|AMRS.ELD|20080226102656||ORU^R01|JqnfhKKtouEz8kzTk6Zo|P|2.5|1||||||||16^AMRS.ELD.FORMID\r"
	...
	public void getUuidFromIdentifiers_shouldFailIfMultipleDifferentUUIDsExistInIdentifiers()
			throws Exception {
		HL7Service hl7service = Context.getHL7Service();
		Message message = hl7service
				.parseHL7String("MSH|^~\\&|FORMENTRY|AMRS.ELD|HL7LISTENER|AMRS.ELD|20080226102656||ORU^R01|JqnfhKKtouEz8kzTk6Zo|P|2.5|1||||||||16^AMRS.ELD.FORMID\r"
	...
	public void resolveLocationId_shouldReturnInternalIdentifierOfLocationIfOnlyLocationNameIsSpecified()
		...
		Assert.assertEquals("Resolved and given locationId shoud be equals",
	...
	public void resolveLocationId_shouldReturnInternalIdentifierOfLocationIfOnlyLocationIdIsSpecified()
			throws Exception {
		executeDataSet("org/openmrs/hl7/include/ORUTest-initialData.xml");
		HL7Service hl7service = Context.getHL7Service();
		Message message = hl7service
	...
	public void resolveLocationId_shouldReturnNullIfLocationIdAndNameAreIncorrect()
			throws Exception {
		executeDataSet("org/openmrs/hl7/include/ORUTest-initialData.xml");
		HL7Service hl7service = Context.getHL7Service();
		Message message = hl7service
