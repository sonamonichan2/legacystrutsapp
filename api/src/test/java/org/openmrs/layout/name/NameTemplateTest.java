...
public class NameTemplateTest {
	...
	public void setup() {
		...
		nameSupport.setSpecialTokens(Arrays.asList("prefix", "givenName",
				"middleName", "familyNamePrefix", "familyNameSuffix",
				"familyName2", "familyName", "degree"));
	}
	...
	public void shouldProperlyFormatNameWithNonTokens() {
		...
		Assert.assertEquals("Goodrich, Mark \"Blue State\"",
				nameTemplate.format(personName));
