...
public class RelationshipTypeValidatorTest extends BaseContextSensitiveTest {
	 ...
	 * @verifies fail validation if aIsToB(or A is To B) is null or empty or
	 *           whitespace
	 */
	@Test
	...
	/**
	 * @see RelationshipTypeValidator#validate(Object,Errors)
	 * @verifies fail validation if bIsToA(or B is To A) is null or empty or
	 *           whitespace
	 */
	@Test
	...
	/**
	 * @see org.openmrs.validator.RelationshipTypeValidator#validate(Object,
	 *      Errors)
	 */
	@Test
