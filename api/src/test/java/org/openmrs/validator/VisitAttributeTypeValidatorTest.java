...
public class VisitAttributeTypeValidatorTest extends BaseContextSensitiveTest {
	...
	/**
	 * @see VisitAttributeTypeValidator#validate(Object,
	...
	public void validate_shouldPassValidationIfFieldLengthsAreCorrect()
		...
		visitAttributeType
				.setDatatypeClassname(RegexValidatedTextDatatype.class
						.getName());
		visitAttributeType.setDescription("some text");
		visitAttributeType.setRetireReason("some text");

		Errors errors = new BindException(visitAttributeType,
				"visitAttributeType");
