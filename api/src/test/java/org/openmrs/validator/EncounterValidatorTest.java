 ...
 * {@link EncounterValidator#validate(Object, Errors)}
 */
public class EncounterValidatorTest extends BaseContextSensitiveTest {
	...
	public void validate_shouldFailIfThePatientsForTheVisitAndTheEncounterDontMatch()
		...
		Assert.assertEquals("Encounter.visit.patients.dontMatch", errors
				.getFieldError("visit").getCode());
	}
	 ...
	 * @see EncounterValidator#validate(Object,
