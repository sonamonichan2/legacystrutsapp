...
public class PersonNameValidatorTest extends BaseContextSensitiveTest {
	...
	public void validate_shouldFailValidationIfPersonNameGivenNameIsNull()
		...
		new PersonNameValidator().validatePersonName(personName, errors, false,
				true);
	...
	public void validate_shouldFailValidationIfPersonNameFamilyNameIsNull()
			throws Exception {
		PersonName personName = new PersonName();
	...
	public void validate_shouldFailValidationIfPersonNameFamilyNameIsEmpty()
			throws Exception {
		PersonName personName = new PersonName();
	...
	public void validate_shouldFailValidationIfPersonNameFamilyNameIsJustSpaces()
			throws Exception {
		PersonName personName = new PersonName();
		personName.setFamilyName("    ");
		Errors errors = new BindException(personName, "familyName");
	...
	public void validate_shouldFailValidationIfPersonNamePrefixIsTooLong()
		...
		personName
				.setPrefix("123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789"); // 100
																																	// characters
																																	// long
	...
	public void validate_shouldFailValidationIfPersonNameGivenNameIsTooLong()
		...
		PersonName personName = new PersonName();
		personName
				.setGivenName("123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789"); // 100
																																		// characters
																																		// long
		Errors errors = new BindException(personName, "givenName");
		new PersonNameValidator().validatePersonName(personName, errors, false,
	...
	public void validate_shouldPassValidationIfPersonNameGivenNameIsExactlyMaxLength()
		...
		PersonName personName = new PersonName();
		personName
				.setGivenName("abcdefghijabcdefghijabcdefghijabcdefghijabcdefghij"); // exactly
																						// 50
																						// characters
																						// long
		Errors errors = new BindException(personName, "givenName");
	...
	public void validate_shouldFailValidationIfPersonNameMiddleNameIsTooLong()
		...
		PersonName personName = new PersonName();
		personName
				.setMiddleName("123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789"); // 100
																																		// characters
																																		// long
	...
	public void validate_shouldFailValidationIfPersonNameFamilyNamePrefixIsTooLong()
		...
		personName.setFamilyName("familyName");
		personName
				.setFamilyNamePrefix("123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789"); // 100
																																				// characters
																																				// long
	...
	public void validate_shouldFailValidationIfPersonNameFamilyNameIsTooLong()
		...
		PersonName personName = new PersonName();
		personName
				.setFamilyName("123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789"); // 100
																																		// characters
																																		// long
		Errors errors = new BindException(personName, "familyName");
		new PersonNameValidator().validatePersonName(personName, errors, false,
	...
	public void validate_shouldFailValidationIfPersonNameFamilyName2IsTooLong()
		...
		PersonName personName = new PersonName();
		personName
				.setFamilyName2("123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789"); // 100
																																		// characters
																																		// long
	...
	public void validate_shouldFailValidationIfPersonNameFamilyNameSuffixIsTooLong()
		...
		personName.setFamilyName("familyName");
		personName
				.setFamilyNameSuffix("123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789"); // 100
																																				// characters
																																				// long
	...
	public void validate_shouldPassValidationIfPersonNameFamilyNameSuffixIsExactlyMaxLength()
		...
		PersonName personName = new PersonName();
		personName
				.setFamilyNameSuffix("12345678901234567890123456789012345678901234567890"); // exactly
																							// 50
																							// characters
																							// long
		Errors errors = new BindException(personName, "familyNameSuffix");
	...
	public void validate_shouldFailValidationIfPersonNameDegreeIsTooLong()
		...
		personName.setFamilyName("familyName");
		personName
				.setDegree("123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789"); // 100
																																	// characters
																																	// long
	...
	public void validate_shouldPassValidationIfPersonNameDegreeIsExactlyMaxLength()
		...
		PersonName personName = new PersonName();
		personName
				.setDegree("12345678901234567890123456789012345678901234567890"); // exactly
																					// 50
																					// characters
																					// long
		Errors errors = new BindException(personName, "degree");
	...
	public void validate_shouldFailValidationIfFieldLengthsAreNotCorrect()
		...
		PersonName personName = new PersonName();
		personName
				.setPrefix("too long text too long text too long text too long text");
		personName
				.setGivenName("too long text too long text too long text too long text");
		personName
				.setMiddleName("too long text too long text too long text too long text");
		personName
				.setFamilyName("too long text too long text too long text too long text");
		personName
				.setFamilyNamePrefix("too long text too long text too long text too long text");
		personName
				.setFamilyName("too long text too long text too long text too long text");
		personName
				.setFamilyName2("too long text too long text too long text too long text");
		personName
				.setFamilyNameSuffix("too long text too long text too long text too long text");
		personName
				.setDegree("too long text too long text too long text too long text");
		personName
	 ...
	 */
	@Test
	public void validate_shouldReportErrorOnCorrectFieldNames()
			throws Exception {
		...
		Method method = personNameValidatorClass.getDeclaredMethod(
				"getFieldKey", new Class[]{String.class, boolean.class,
						boolean.class});
