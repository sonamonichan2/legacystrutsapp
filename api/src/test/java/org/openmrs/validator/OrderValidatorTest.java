...
public class OrderValidatorTest extends BaseContextSensitiveTest {
	 ...
	 * @see OrderValidator#validate(Object,
	...
	public void validate_shouldFailValidationIfOrderIsNull() throws Exception {
		...
		Assert.assertEquals("error.general",
	...
	/**
	 * @verifies fail validation if dateActivated is before encounter's
	 *           encounterDatetime
	 * @see OrderValidator#validate(Object,
	 *      org.springframework.validation.Errors)
	 */
	...
	/**
	 * @verifies fail validation if scheduledDate is null when urgency is
	 *           ON_SCHEDULED_DATE
	 * @see OrderValidator#validate(Object,
	 *      org.springframework.validation.Errors)
	 */
	...
	/**
	 * @verifies fail validation if scheduledDate is set and urgency is not set
	 *           as ON_SCHEDULED_DATE
	 * @see OrderValidator#validate(Object,
	 *      org.springframework.validation.Errors)
	 */
	@Test
	...
	/**
	 * @verifies fail validation if orderType.javaClass does not match
	 *           order.class
	 * @see OrderValidator#validate(Object,
	 *      org.springframework.validation.Errors)
	 */
	...
	public void validate_shouldFailValidationIfOrderTypejavaClassDoesNotMatchOrderclass()
		...
		Assert.assertTrue(Arrays.asList(
				errors.getFieldError("orderType").getCodes()).contains(
				"Order.error.orderTypeClassMismatchesOrderClass"));
	}

	/**
	 * @verifies pass validation if the class of the order is a subclass of
	 *           orderType.javaClass
	 * @see OrderValidator#validate(Object,
	 *      org.springframework.validation.Errors)
	 */
	...
	public void validate_shouldNotAllowAFutureDateActivated() throws Exception {
		...
		Assert.assertTrue(errors.hasFieldErrors("dateActivated"));
		Assert.assertEquals("Order.error.dateActivatedInFuture", errors
				.getFieldError("dateActivated").getCode());
	}
	...
	public void saveOrder_shouldNotSaveOrderIfInvalidOrderGroupEncounter()
		...
		Order order = new OrderBuilder().withAction(Order.Action.NEW)
	...
	public void saveOrder_shouldNotSaveOrderIfInvalidOrderGroupPatient()
		...
		Assert.assertTrue(errors.hasFieldErrors("patient"));
		Assert.assertEquals(
				"Order.error.orderPatientAndOrderGroupPatientMismatch", errors
						.getFieldError("patient").getCode());
	}
}
