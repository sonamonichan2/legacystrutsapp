...
public class UserValidatorTest extends BaseContextSensitiveTest {
	...
	private void invokeValidateAndAssertHasErrorRetireReason(
			String invalidRetireReason) {
		User user = new User();
	...
	public void isUserNameAsEmailValid_shouldReturnFalseIfEmailInvalid()
			throws Exception {
		String[] invalids = new String[]{"mkyong", "mkyong123@.com", "my@kong",
				"my.kong", "my.@kong", "@kong.my"};
	...
	public void isUserNameAsEmailValid_shouldReturnTrueIfEmailValid()
			throws Exception {
		String[] valids = new String[]{"mkyong@yahoo.com",
	...
	public void validate_shouldFailValidationIfEmailAsUsernameEnabledAndEmailInvalid()
		...
		as.saveGlobalProperty(new GlobalProperty(
				OpenmrsConstants.GLOBAL_PROPERTY_USER_REQUIRE_EMAIL_AS_USERNAME,
				"true"));
	...
	/**
	 * @see UserValidator#validate(Object,Errors)
	 * @verifies fail validation if email as username disabled and email
	 *           provided
	 */
	@Test
	...
	public void validate_shouldFailValidationIfFieldLengthsAreNotCorrect()
		...
		user.getPerson().addName(
				new PersonName(STRING_WITH_LENGTH_GREATER_THAN_50,
