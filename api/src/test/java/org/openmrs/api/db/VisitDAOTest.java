...
/**
 * Contains the tests for {@link VisitDAO} methods that don't have equivalents
 * at the {@link VisitService} layer
 */
public class VisitDAOTest extends BaseContextSensitiveTest {
	 ...
	 *      java.util.Collection, java.util.Collection, java.util.Date,
	 *      java.util.Date, java.util.Date, java.util.Date, boolean, boolean)
	 */
	@Test
	...
	public void getVisits_shouldReturnAllUnvoidedVisitsIfIncludeEndedIsSetToTrue()
		...
		Assert.assertEquals(
				13,
				dao.getVisits(null, null, null, null, null, null, null, null,
	...
	public void getNextVisit_shouldReturnTheNextUnvoidedActiveVisitMatchingTheSpecifiedTypesAndStartDate()
		...
		Assert.assertEquals(105,
				dao.getNextVisit(dao.getVisit(1), visitTypes, cal.getTime())
						.getVisitId().intValue());
	}
}
