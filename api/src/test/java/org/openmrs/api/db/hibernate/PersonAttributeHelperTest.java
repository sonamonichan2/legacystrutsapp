...
public class PersonAttributeHelperTest extends BaseContextSensitiveTest {
	...
	private final static Log log = LogFactory
			.getLog(PersonAttributeHelperTest.class);
	...
	public void personAttributeExists_shouldReturnTrueIfAPersonAttributeExists()
		...
		Assert.assertFalse(helper
				.personAttributeExists("Unexpected attribute value"));
	}
	...
	public void voidedPersonAttributeExists_shouldReturnTrueIfAVoidedPersonAttributeExists()
		...
		Assert.assertFalse(helper
				.voidedPersonAttributeExists("Unexpected attribute value"));
	}
	...
	public void nonVoidedPersonAttributeExists_shouldReturnTrueIfANonvoidedPersonAttributeExists()
		...
		Assert.assertTrue(helper
				.nonVoidedPersonAttributeExists("Porridge with honey"));

		Assert.assertFalse(helper
				.nonVoidedPersonAttributeExists("Unexpected attribute value"));
	}
	...
	public void nonSearchablePersonAttributeExists_shouldReturnTrueIfANonsearchablePersonAttributeExists()
			throws Exception {
		Assert.assertFalse(helper
				.nonSearchablePersonAttributeExists("Master thief"));
		Assert.assertFalse(helper
				.nonSearchablePersonAttributeExists("Senior ring bearer"));
		Assert.assertFalse(helper
				.nonSearchablePersonAttributeExists("Story teller"));
		...
		Assert.assertFalse(helper
				.nonSearchablePersonAttributeExists("Unexpected attribute value"));
	}
	...
	public void searchablePersonAttributeExists_shouldReturnTrueIfASearchablePersonAttributeExists()
			throws Exception {
		Assert.assertTrue(helper
				.searchablePersonAttributeExists("Master thief"));
		Assert.assertTrue(helper
		...
		Assert.assertFalse(helper
				.searchablePersonAttributeExists("Porridge with honey"));
		Assert.assertFalse(helper
				.searchablePersonAttributeExists("Mushroom pie"));
