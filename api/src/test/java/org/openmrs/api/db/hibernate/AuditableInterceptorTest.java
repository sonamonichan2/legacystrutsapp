...
public class AuditableInterceptorTest extends BaseContextSensitiveTest {
	...
	public void onFlushDirty_shouldReturnFalseForNonAuditableObjects()
		...
		boolean returnValue = interceptor.onFlushDirty(o, null, null, null,
				null, null);

		Assert.assertFalse(
				"false should have been returned because we didn't pass in an Auditable or OpenmrsObject",
				returnValue);
	}
	...
	public void onFlushDirty_shouldSetTheChangedByField() throws Exception {
		...
		interceptor.onFlushDirty(u, null, currentState, previousState,
				propertyNames, null);
	...
	public void onFlushDirty_shouldAddPersonChangedByForPerson()
		...
		interceptor.onFlushDirty(person, null, currentState, null,
				propertyNames, null);
		Assert.assertNotNull(currentState[0]);
	}
	...
	public void onFlushDirty_shouldNotFailWithNullPreviousState()
		...
		interceptor.onFlushDirty(u, null, currentState, null, propertyNames,
				null);
	}

	/**
	 * This test makes sure that the AuditableInterceptor is registered on the
	 * session
	 * 
	 * @see AuditableInterceptor#onFlushDirty(Object,Serializable,Object[],Object[],String[],Type[])
	 ...
	 */
	@Test
	public void onFlushDirty_shouldNotFailWhenTheDaemonUserModifiesSomething()
			throws Throwable {
		new AsDaemonTask(new AbstractTask() {

			@Override
			public void execute() {
				ConceptNumeric weight = Context.getConceptService()
	...
	public void onSave_shouldReturnTrueIfDateCreatedWasNull() throws Exception {
		...
		boolean result = interceptor.onSave(u, 0, currentState, propertyNames,
				null);
