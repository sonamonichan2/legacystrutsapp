...
public class PatientDataVoidHandlerTest extends BaseContextSensitiveTest {
	...
	public void handle_shouldVoidTheOrdersEncountersAndObservationsAssociatedWithThePatient()
		...
		// we should have some unvoided encounters, obs and orders for the test
		// to be concrete
		...
		new PatientDataVoidHandler().handle(patient, new User(1), new Date(),
				"voidReason");
		...
		// refresh the lists and check that all encounters, obs and orders were
		// voided
