...
/**
 * Extension of {@link BaseOpenmrsData} for classes that support customization
 ...
 * @since 1.9
 */
public abstract class BaseCustomizableData<A extends Attribute>
		extends
			BaseOpenmrsData implements Customizable<A> {
