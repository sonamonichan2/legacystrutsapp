 ...
 * {@link OpenmrsClassLoader} will be used to find files (or any other
 * classloader that is passed into the contructor). This allows liquibase xml
 * files in modules to be found.
 */
public class ClassLoaderFileOpener implements ResourceAccessor {
	...
	/**
	 * @param cl
	 *            the {@link ClassLoader} to use for finding files.
	 */
