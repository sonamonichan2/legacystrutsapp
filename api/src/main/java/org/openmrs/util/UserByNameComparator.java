...
/**
 * A simple user comparator for sorting users by personName. Sorts names based
 * on the following precedence: FamilyName, FamilyName2, GivenName, MiddleName,
...
public class UserByNameComparator implements Comparator<User> {
	...
	public int compare(User user1, User user2) {
		...
		return PersonByNameComparator.comparePersonsByName(user1.getPerson(),
				user2.getPerson());
	}
}
