...
/**
 * Used by the {@link DatabaseUpdater} to signal that a given update requires
 * input from the user.
 * 
 * @since 1.5
 */
public class InputRequiredException extends Exception {
	 ...
	 * 
	 * @param requiredInput
	 *            a list of questions that need to be answered in the form
	 *            question, type
	 */
	...
	/**
	 * The user prompts and datatype for each question that the user has to
	 * provide input for
	 * 
