...
/**
 * A utility class which sorts a collection of ConceptMapType objects in the
 * following order:
 * <ol>
 * <li>Regular</li>
 * <li>Retired</li>
...
public class ConceptMapTypeComparator implements Comparator<ConceptMapType> {
	 ...
	 */
	@Override
	public int compare(ConceptMapType conceptMapType,
	...
	/**
	 * <p>
	 * This method calculates a weight used to decide the object's order in a
	 * collection.
	 * </p>
	 * 
	 * @param conceptMapType
	 *            the ConceptMapType object the weight of which is to be
	 *            calculated
	 * @return <ol>
	 *         <li>Regular: 0</li>
	 *         <li>Retired: 1</li>
	...
	public static int getConceptMapTypeSortWeight(ConceptMapType conceptMapType) {
		return ((conceptMapType.isRetired() ? 1 : 0) + (conceptMapType
				.isHidden() ? 2 : 0));
	}
}
