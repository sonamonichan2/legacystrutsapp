...
/**
 * Disables all triggers for the current schema Postgres does not have a call to
 * disable all foreign key constraints. This changeset alters table and disable
