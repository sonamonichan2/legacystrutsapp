...
public class ExceptionUtil {
	...
	/**
	 * If any cause in the exception chain is an instance of causeType, then
	 * rethrow that exception
	 * 
	 * @param thrown
	 * @param causeType
	 *            must be a {@link RuntimeException} so that we can throw it
	 * @should allow an intermediate exception to be rethrown
	 */
	public static void rethrowIfCause(Throwable thrown,
	...
	/**
	 * If any cause in the given exception chain is an
	 * APIAuthenticationException, rethrow that
	 * 
	 * @param thrown
	 */
