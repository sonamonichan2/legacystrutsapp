...
/**
 * It is a wrapper for a partial collection, which stores additional info about
 * the current part and the whole.
 * 
 * @since 1.11
 */
public abstract class CollectionPart<E> {
	...
	public CollectionPart(Collection<E> collection, Long firstElement,
