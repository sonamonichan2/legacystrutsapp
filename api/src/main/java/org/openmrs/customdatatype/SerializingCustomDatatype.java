...
public abstract class SerializingCustomDatatype<T> implements CustomDatatype<T> {
	...
	/**
	 * @param typedValue
	 *            (has already had validate called)
	...
	/**
	 * Most implementations should override this method to return plain-text
	 * summary of the typed value, as defined by
	 * {@link CustomDatatype#getTextSummary(String)}. If
	 * {@link #deserialize(String)} is expensive, then the implementation should
	 * override {@link #getTextSummary(String)} instead.
	 * 
	 * The default implementation returns typedValue.toString(), and indicates
	 * it is complete.
	 * 
	 * @param typedValue
	 ...
	 */
	@Override
	public T fromReferenceString(String persistedValue)
	 ...
	 */
	public String getReferenceStringForValue(T typedValue)
			throws UnsupportedOperationException {
		return serialize(typedValue);
	}

	/**
	 * Default implementation calls {@link #doGetTextSummary(Object)}. Most
	 * implementations should override that other method, but if
	 * {@link #deserialize(String)} is expensive, then you should override this
	 * method instead.
	 * 
