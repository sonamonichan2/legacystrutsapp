...
/**
 * The frequency at which an Order's action should be repeated, e.g. TWICE DAILY
 * or EVERY 6 HOURS. This class is backed by a Concept for i18n, synonyms,
 * mappings, etc, but it contains additional details an electronic system can
 * use to understand its meaning.
 * 
 * @since 1.10
 */
