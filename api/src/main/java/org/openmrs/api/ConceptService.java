 ...
 * Drugs, Concept Proposals, and all other things 'Concept'.
 * <p>
...
public interface ConceptService extends OpenmrsService {
	...
	/**
	 * Save or update the given <code>Concept</code> or
	 * <code>ConceptNumeric</code> in the database
	 * <p>
	 * If this is a new concept, the returned concept will have a new
	 * {@link Concept#getConceptId()} inserted into it that was generated by the
	 * database
	 * 
	 * @param concept
	 *            The <code>Concept</code> or <code>ConceptNumeric</code> to
	 *            save or update
	 ...
	 * @should create a reference term for a concept mapping on the fly when
	 *         editing a concept
	 * @should create a reference term for a concept mapping on the fly when
	 *         creating a concept
	 * @should add new concept name
	 * @should not set audit info if the concept is not edited
	 * @should set audit info if an item is removed from any of its child
	 *         collections
	 * @should set audit info if any item in the child collections is edited
	 * @should set audit info if an item is added to any of its child
	 *         collections
	...
	/**
	 * Save or update the given <code>Drug</code> in the database. If this is a
	 * new drug, the returned drug object will have a new
	 * {@link Drug#getDrugId()} inserted into it that was generated by the
	 * database
	 * 
	 * @param drug
	...
	/**
	 * Completely purge a <code>Concept</code> or <code>ConceptNumeric</code>
	 * from the database. This should not typically be used unless desperately
	 * needed. Most should just be retired. See
	 * {@link #retireConcept(Concept, String)}
	 * 
	 * @param conceptOrConceptNumeric
	 *            The <code>Concept</code> or <code>ConceptNumeric</code> to
	 *            remove from the system
	 * @throws APIException
	 * @should fail if any of the conceptNames of the concept is being used by
	 *         an obs
	 */
	@Authorized(PrivilegeConstants.PURGE_CONCEPTS)
	public void purgeConcept(Concept conceptOrConceptNumeric)
			throws APIException;
	...
	/**
	 * Completely purge a Drug from the database. This should not typically be
	 * used unless desperately needed. Most Drugs should just be retired.
	 * 
	 * @param drug
	 ...
	 * 
	 * @return a List&lt;Concept&gt; object containing all of the sorted
	 *         concepts
	 * @throws APIException
	 */
	@Authorized(PrivilegeConstants.GET_CONCEPTS)
	 ...
	 * 
	 * @param sortBy
	 *            The property name to sort by; if null or invalid, concept_id
	 *            is used.
	 * @param asc
	 *            true = sort ascending; false = sort descending
	 * @param includeRetired
	 *            If <code>true</code>, retired concepts will also be returned
	 * @return a List&lt;Concept&gt; object containing all of the sorted
	 *         concepts
	 * @throws APIException
	...
	/**
	 * Returns a list of concepts matching any part of a concept name, this
	 * method is case insensitive to the concept name string
	 * 
	 * @param name
	 *            The search string
	 * @throws APIException
	 * @return a List&lt;Concept&gt; object containing all of the matching
	 *         concepts
	...
	/**
	 * Get drugs by concept. This method is the utility method that should be
	 * used to generically retrieve all Drugs in the system.
	 * 
	 * @param includeRetired
	 ...
	 * drug.concept.name, drug.drugId or drug.concept.conceptId
	 * 
	 * @param phrase
	 *            Search phrase
	 * @throws APIException
	 ...
	 * getConceptSets(getConcept("ANTIRETROVIRAL MEDICATIONS")) and then take
	 * the conceptIds from the resulting list.
	 * 
	 * @param concept
	 *            The concept representing the concept set
	 * @return A List&lt;ConceptSet&gt; object containing all matching
	 *         ConceptSets
	 * @throws APIException
	 */
	@Authorized(PrivilegeConstants.GET_CONCEPTS)
	 ...
	 * @return a List&lt;ConceptProposal&gt; object of all found
	 *         ConceptProposals
	 * @throws APIException
	 */
	 ...
	 * 
	 * @param text
	 * @return a List&lt;Concept&gt; object containing matching proposed
	 *         concepts
	 * @throws APIException
	 */
	@Authorized(PrivilegeConstants.GET_CONCEPT_PROPOSALS)
	...
	@Authorized({PrivilegeConstants.ADD_CONCEPT_PROPOSALS,
			PrivilegeConstants.EDIT_CONCEPT_PROPOSALS})
	...
	/**
	 * Returns all possible Concepts to which this concept is a value-coded
	 * answer. To navigate in the other direction, i.e., from Concept to its
	 * answers use Concept.getAnswers()
	 * 
	 * @param concept
	 * @return A List&lt;Concept&gt; containing all possible questions to which
	 *         this concept is a valued_Coded answer
	 * @throws APIException
	 */
	@Authorized(PrivilegeConstants.GET_CONCEPTS)
	...
	/**
	 * Finds the previous concept in the dictionary that has the next lowest
	 * concept id
	 * 
	 * @param concept
	 *            the offset Concept
	...
	/**
	 * Finds the next concept in the dictionary that has the next largest
	 * concept id
	 * 
	 * @param concept
	 *            the offset Concept
	...
	/**
	 * Convenience method for finding concepts associated with drugs in
	 * formulary.
	 * 
	...
	/**
	 * Return a list of concept sources currenly in the database Whether or not
	 * to return retired concept sources is decided by the boolean
	 * includeRetired param
	 * 
	 * @param includeRetired
	...
	/**
	 * This effectively removes a concept source from the database. The source
	 * can still be referenced by old data, but no new data should use this
	 * source.
	 * 
	 * @param cs
	 *            the concept source to retire
	 * @param reason
	 *            why the concept source is to be retired, must not be empty of
	 *            null
	...
	/**
	 * Creates a new Concept name tag if none exists. If a tag exists with the
	 * same name then that existing tag is returned.
	 * 
	 * @param nameTag
	 ...
	 * {@link Concept} which contains a {@link ConceptMap} entry whose
	 * <code>sourceCode</code> is equal to the passed <code>conceptCode</code>
	 * and whose {@link ConceptSource} has either a <code>name</code> or
	 * <code>hl7Code</code> that is equal to the passed <code>mappingCode</code>
	 * . Delegates to getConceptByMapping(code,sourceName,includeRetired) with
	 * includeRetired=true
	 * 
	 * @param code
	 *            the code associated with a concept within a given
	 *            {@link ConceptSource}
	 * @param sourceName
	 *            the name or hl7Code of the {@link ConceptSource} to check
	 ...
	 * and whose {@link ConceptSource} has either a <code>name</code> or
	 * <code>hl7Code</code> that is equal to the passed <code>mappingCode</code>
	 * . Operates under the assumption that each mappingCode in a
	 * {@link ConceptSource} references one and only one non-retired
	 * {@link Concept}: if the underlying dao method returns more than one
	 * non-retired concept, this method will throw an exception; if the
	 * underlying dao method returns more than one concept, but only one
	 * non-retired concept, this method will return the non-retired concept; if
	 * the dao only returns retired concepts, this method will simply return the
	 * first concept in the list returns by the dao method; retired concepts can
	 * be excluded by setting the includeRetired parameter to false, but the
	 * above logic still applies
	 * 
	 * @param code
	 *            the code associated with a concept within a given
	 *            {@link ConceptSource}
	 ...
	 * concepts {@link Concept}s which contain a {@link ConceptMap} entry whose
	 * <code>sourceCode</code> is equal to the passed <code>conceptCode</code>
	 * and whose {@link ConceptSource} has either a <code>name</code> or
	 * <code>hl7Code</code> that is equal to the passed <code>mappingCode</code>
	 * 
	 ...
	 * @param sourceName
	 *            the name or hl7Code of the {@link ConceptSource} to check
	 * @return the list of non-voided {@link Concept}s that has the given
	 *         mapping, or null if no {@link Concept} found
	 * @throws APIException
	 ...
	 * and whose {@link ConceptSource} has either a <code>name</code> or
	 * <code>hl7Code</code> that is equal to the passed <code>mappingCode</code>
	 * . Delegates to getConceptsByMapping(code,sourceName,includeRetired) with
	 * includeRetired=true
	 * 
	 * @param code
	 *            the code associated with a concept within a given
	...
	/**
	 * Get all the concept name tags defined in the database, included voided
	 * ones
	 * 
	 * @since 1.5
	...
	/**
	 * Checks if there are any observations (including voided observations) for
	 * a concept.
	 * 
	 * @param concept
	 ...
	 * observations it is associated to.
	 * 
	 * @param conceptToChange
	...
	/**
	 * Checks if there are any observations (including voided observations)
	 * using a conceptName.
	 * 
	 * @param conceptName
	 *            which is used or not used by an observation
	 * @return boolean true if the conceptName is used by an observation
	 *         otherwise false
	 * @throws APIException
	 * @since Version 1.7
	 */
	 ...
	 * 
	 * @param phrase
	 *            matched to the start of any word in any of the names of a
	 *            concept (if blank/null, matches all concepts)
	 * @param locales
	 *            List&lt;Locale&gt; to restrict to
	 * @param includeRetired
	 *            boolean if false, will exclude retired concepts
	 * @param requireClasses
	 *            List&lt;ConceptClass&gt; to restrict to
	 * @param excludeClasses
	 *            List&lt;ConceptClass&gt; to leave out of results
	 * @param requireDatatypes
	 *            List&lt;ConceptDatatype&gt; to restrict to
	 * @param excludeDatatypes
	 *            List&lt;ConceptDatatype&gt; to leave out of results
	 * @param answersToConcept
	 *            all results will be a possible answer to this concept
	 * @param start
	 *            all results less than this number will be removed
	 * @param size
	 *            if non zero, all results after <code>start</code> +
	 *            <code>size</code> will be removed
	 * @return a list of conceptSearchResults
	 * @throws APIException
	 * @should return concept search results that match unique concepts
	 * @should return a search result whose concept name contains all word
	 *         tokens as first
	...
	/**
	 * Iterates over the words in names and synonyms (for each locale) and
	 * updates the concept index, note that this only updates the index of the
	 * specified concept. Use {@link ConceptService#updateConceptIndexes()} if
	 * you wish to update the entire concept index.
	 * 
	 * @param concept
	 *            the concept whose index is to be updated
	 * @throws APIException
	 * @since 1.8
	 */
	@Authorized({PrivilegeConstants.MANAGE_CONCEPTS})
	...
	/**
	 * Iterates over all concepts and calls upddateConceptIndexes(Concept
	 * concept)
	 * 
	 * @throws APIException
	 * @since 1.8
	 ...
	 * 
	 * @param phrase
	 *            the string to search against (if blank/null, matches all
	 *            concepts)
	 * @param locale
	 *            the locale in which to search for the concepts
	 * @param includeRetired
	 *            Specifies whether to include retired concepts
	 ...
	 *            Specifies if the search should match names starting with or
	 *            contain the text
	 * @param searchDrugConceptNames
	 *            Specifies whether a search on concept names for the drug's
	 *            concept should be done or not
	 * @param includeRetired
	 *            specifies whether to include retired drugs
	...
	/**
	 * Returns a list of drugs with matching names or concept drug names and
	 * returns a specific number of them from the specified starting position.
	 ...
	 *            (since 1.11) Specifies whether the search should match
	 *            keywords or just phrase
	 * @param searchDrugConceptNames
	 *            Specifies whether a search on concept names for the drug's
	 *            concept should be done or not
	 * @param includeRetired
	 ...
	 * 
	 * @param locale
	 *            The locale in which to search for the
	 ...
	 * @should return default Locale <code>ConceptStopWord</code> if Locale is
	 *         null
	 * @since 1.8
	 */
	 ...
	 * <p>
	 * If this is a new concept stop word, the returned concept stop word will
	 * have a new {@link org.openmrs.ConceptStopWord#getConceptStopWordId()}
	 ...
	 * 
	 * @param conceptStopWordId
	 *            The <code>ConceptStopWord</code> to delete
	 * @throws APIException
	...
	/**
	 * Gets drugs by the given ingredient, which can be either the drug itself
	 * or any ingredient.
	 * 
	...
	/**
	 * Returns a list of concept map types currently in the database including
	 * or excluding retired and hidden ones as specified by the includeRetired
	 * and includeHidden arguments
	 * 
	 * @param includeRetired
	 ...
	 * @since 1.9
	 * @throws APIException
	 * @should return all the concept map types if includeRetired and hidden are
	 *         set to true
	 * @should return only un retired concept map types if includeRetired is set
	 *         to false
	 * @should not include hidden concept map types if includeHidden is set to
	 *         false
	 */
	@Authorized(PrivilegeConstants.GET_CONCEPT_MAP_TYPES)
	 ...
	 *            the concept map type to save
	 * @return the saved conceptMapType
	 * @since 1.9
	 * @throws APIException
	 * @should add the specified concept map type to the database and assign to
	 *         it an id
	 ...
	 * 
	 * @param conceptMapType
	 *            the concept map type to retire
	 * @param retireReason
	 *            the reason why the concept map type is being retired
	 ...
	 * 
	 * @param conceptMapType
	 *            the concept map type to unretire
	 * @return the unretired concept map type
	 * @since 1.9
	 * @throws APIException
	 * @should unretire the specified concept map type and drop all retire
	 *         related fields
	 */
	@Authorized(PrivilegeConstants.MANAGE_CONCEPT_MAP_TYPES)
	 ...
	 * 
	 * @param conceptMapType
	 *            the concept map type to purge from the database
	 * @since 1.9
	 * @throws APIException
	 ...
	 * 
	 * @param includeRetired
	 *            specifies if retired concept reference terms should be
	 *            included
	 * @return a list of concept reference terms
	 * @since 1.9
	 * @throws APIException
	 * @should return all the concept reference terms if includeRetired is set
	 *         to true
	 * @should return only un retired concept reference terms if includeRetired
	 *         is set to false
	 */
	@Authorized(PrivilegeConstants.GET_CONCEPT_REFERENCE_TERMS)
	...
	/**
	 * Gets the concept reference term with the specified concept reference term
	 * id
	 * 
	 * @param conceptReferenceTermId
	 *            the concept reference term id to search against
	 * @return the concept reference term object with the given concept
	 *         reference term id
	 * @since 1.9
	 * @throws APIException
	 */
	 ...
	 * concept source ignoring all retired ones
	 * 
	 * @param name
	 *            the name to match against
	 * @param conceptSource
	 *            the concept source to match against
	 * @return concept reference term object
	 * @since 1.9
	 * @throws APIException
	 * @should return a concept reference term that matches the given name from
	 *         the given source
	 * @should be case insensitive
	 */
	@Authorized(PrivilegeConstants.GET_CONCEPT_REFERENCE_TERMS)
	 ...
	 * @since 1.9
	 * @throws APIException
	 * @should return a concept reference term that matches the given code from
	 *         the given source
	 */
	@Authorized(PrivilegeConstants.GET_CONCEPT_REFERENCE_TERMS)
	 ...
	 *            the concept reference term object to save
	 * @return the saved concept reference term object
	 * @since 1.9
	 * @throws APIException
	 * @should add a concept reference term to the database and assign an id to
	 *         it
	 ...
	 * 
	 * @param conceptReferenceTerm
	 *            the concept reference term object to retire
	 * @param retireReason
	 *            the reason why the concept reference term is being retired
	 * @return the retired concept reference term object
	 * @since 1.9
	 * @throws APIException
	 * @should retire the specified concept reference term with the given retire
	 *         reason
	 * @should should set the default retire reason if none is given
	 */
	@Authorized(PrivilegeConstants.MANAGE_CONCEPT_REFERENCE_TERMS)
	 ...
	 * 
	 * @param conceptReferenceTerm
	 *            the concept reference term to unretire
	 * @return the unretired concept reference term
	 * @since 1.9
	 * @throws APIException
	 * @should unretire the specified concept reference term and drop all retire
	 *         related fields
	 */
	@Authorized(PrivilegeConstants.MANAGE_CONCEPT_REFERENCE_TERMS)
	 ...
	 * 
	 * @param conceptReferenceTerm
	 *            the concept reference term object to purge
	 * @since 1.9
	 * @throws APIException
	 */
	 ...
	 * that contains the specified search phrase.
	 * 
	 * @param query
	 *            the string to match against the reference term names or codes
	 * @param conceptSource
	 *            the concept source from which the terms should be looked up
	 * @param start
	 *            beginning index for the batch
	 * @param length
	 *            number of terms to return in the batch
	 * @param includeRetired
	 *            specifies if the retired terms should be included
	 * @return a list if {@link ConceptReferenceTerm}s
	 * @since 1.9
	 * @throws APIException
	 * @should return unique terms with a code or name containing the search
	 *         phrase
	 * @should return only the concept reference terms from the given concept
	 *         source
	 */
	@Authorized({PrivilegeConstants.GET_CONCEPT_REFERENCE_TERMS})
	 ...
	 * 
	 * @param query
	 *            the string to match against the reference term names
	 * @param conceptSource
	 *            the concept source from which the terms should be looked up
	 * @param includeRetired
	 *            specifies if retired concept reference terms should be
	...
	/**
	 * Fetches all the {@link ConceptReferenceTermMap} where the specified
	 * reference term is the termB i.e mappings added to other terms pointing to
	 * it
	 * 
	 * @param term
	 ...
	 * @since 1.9
	 * @throws APIException
	 * @should return all concept reference term maps where the specified term
	 *         is the termB
	 */
	@Authorized(PrivilegeConstants.GET_CONCEPT_REFERENCE_TERMS)
	 ...
	 * <p>
	 * This method is case insensitive. It searches for exactly matching names
	 * and close matching locales (if exactLocale = false). It considers only
	 * non-voided names and all concepts.
	 * 
	 * @param name
	 * @param locale
	 *            <code>null</code> = all locales
	 * @param exactLocale
	 *            <code>false</code> if search for both global and country
	 *            specific, <code>true</code> if <code>null</code>
	 * @return the list of concepts
	 * @throws APIException
	 * @since 1.9, 1.8.4
	 * @should return concepts for all countries and global language given
	 *         language only locale
	 * @should return concepts for specific country and global language given
	...
	/**
	 * Gets the concept map type to be used as the default. It is specified by
	 * the <code>concept.defaultConceptMapType</code> global property.
	 * 
	 * @since 1.9
	 ...
	 * <p>
	 * Concept name is considered duplicate if it is a default non-retired name
	 * for a non-voided concept and there is another name, which is:
	 * <ol>
	...
	/**
	 * Fetches un retired drugs that match the specified search phrase. The
	 * logic matches on drug names, concept names of the associated concepts or
	 * the concept reference term codes of the drug reference term mappings
	 * 
	 * @param searchPhrase
	 *            The string to match against
	 * @param locale
	 *            The locale to match against when searching in drug concept
	 *            names
	 * @param exactLocale
	 *            If false then concepts with names in a broader locale will be
	 *            matched e.g in case en_GB is passed in then en will be matched
	 * @param includeRetired
	 *            Specifies if retired drugs that match should be included or
	 *            not
	 * @return A list of matching drugs
	 * @since 1.10
	 ...
	 * @should get drugs linked to concepts with names that match the phrase and
	 *         locale
	 * @should get drugs linked to concepts with names that match the phrase and
	 *         related locales
	 * @should get drugs that have mappings with reference term codes that match
	 *         the phrase
	 * @should return unique drugs
	 * @should return all drugs with a matching term code or drug name or
	 *         concept name
	 ...
	 * that match the specified code and concept map types
	 * 
	 * @param code
	 *            the code the reference term code to match on
	 * @param conceptSource
	 *            the concept source on which to match on
	 * @param withAnyOfTheseTypes
	 *            the ConceptMapTypes to match on
	 * @param includeRetired
	 *            specifies if retired drugs should be included or not
	 * @since 1.10
	 * @return the list of {@link Drug}
	 * @throws APIException
	 * @should get a list of all drugs that match on all the parameter values
	 * @should return retired and non-retired drugs if includeRetired is set to
	 *         true
	 ...
	 * @should fail if no code and concept source and withAnyOfTheseTypes are
	 *         provided
	 ...
	 * passed in e.g. getDrugByMapping("12345", rxNorm, Arrays.asList(sameAs,
	 * narrowerThan)) If there are multiple matches for the highest-priority
	 * ConceptMapType, throw an exception
	 * 
	 * @param code
	 *            the code the reference term code to match on
	 * @param conceptSource
	 *            the concept source to match on
	 ...
	 * @should return a drug that matches the code and source and the best map
	 *         type
	 ...
	 * order_type_class_map table. This method searches for orderable concepts
	 * which match the specified arguments
	 * 
	 * @param phrase
	 *            the phrase to match on
	 * @param locales
	 *            list of locales to match on
	 * @param includeRetired
	 *            include retired concepts or not
	 * @param start
	 *            start index of search results
	 * @param length
	 *            number of concept results to be returned
	 ...
	 * @should return null if no concept attribute type exists with the given
	 *         uuid
	 */
	@Authorized(PrivilegeConstants.GET_CONCEPT_ATTRIBUTE_TYPES)
	...
	/**
	 * Find concept attribute types matching the given parameters. Retired types
	 * are included in the results
	 * 
	 * @param name
	 *            (optional) The name of type
	 * @return list of ConceptAttributeTypes that matches <em>name</em>
	 *         partially or completely
	 * @since 2.0
	 * @throws APIException
	 * @should return concept attribute types performing fuzzy match on given
	 *         name
	 * @should return empty list when no concept attribute types match given
	 *         name
	 */
	@Authorized({PrivilegeConstants.GET_CONCEPT_ATTRIBUTE_TYPES})
	 ...
	 * 
	 * @param conceptAttributeType
	 *            the concept attribute type to be retired
	 * @param reason
	 *            for retiring the concept attribute type
	 ...
	 * 
	 * @param conceptAttributeType
	 *            the concept type attribute to unretire
	 ...
	 *        attributes) for a concept attribute type.
	 * 
