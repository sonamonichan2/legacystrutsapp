...
/**
 * Is called when any {@link OpenmrsMetadata} object is being saved. Trims out
 * the leading and trailing whitespace around the name and description
 */
public class OpenmrsMetadataSaveHandler implements SaveHandler<OpenmrsMetadata> {
	 ...
	 */
	@Override
	public void handle(OpenmrsMetadata object, User creator, Date dateCreated,
			String other) {
