...
/**
 * This class sets the personVoid* attributes on the given {@link Person} object
 * when a void* method is called with this class. This differs from the
 * {@link BaseVoidHandler} because the Person object contains personVoided*
 * attributes instead of the normal voided attributes
 * 
...
public class PersonVoidHandler implements VoidHandler<Person> {
	 ...
	 * @should retire users
	 */
	public void handle(Person person, User voidingUser, Date voidedDate,
			String voidReason) {
