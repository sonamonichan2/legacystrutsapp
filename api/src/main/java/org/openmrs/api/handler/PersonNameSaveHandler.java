...
/**
 * This is called every time a {@link PersonName} object is saved. The current
 * implemention just trims out the whitespace from the beginning and end of the
 * given/middle/familyname/familyName2 attributes
 */
...
public class PersonNameSaveHandler implements SaveHandler<PersonName> {
	 ...
	 */
	public void handle(PersonName personName, User creator, Date dateCreated,
			String other) {
