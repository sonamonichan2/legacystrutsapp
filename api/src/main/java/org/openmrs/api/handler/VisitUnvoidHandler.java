...
/**
 * This class sets the void attributes on the given {@link Visit} object when an
 * unvoid* method is called with this class. This differs from the
 * {@link BaseUnvoidHandler} because unvoiding the Visit object implies
 * unvoiding encounters voided with that visit.
 * 
...
public class VisitUnvoidHandler implements UnvoidHandler<Visit> {
	...
	@Override
	public void handle(Visit visit, User voidingUser,
