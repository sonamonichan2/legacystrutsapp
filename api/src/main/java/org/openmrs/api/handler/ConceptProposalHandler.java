...
/**
 * This class deals with {@link ConceptProposal} objects when they are saved via
 * a save* method in an Openmrs Service. This handler is automatically called by
...
public class ConceptProposalHandler implements SaveHandler<ConceptProposal> {
	 ...
	 */
	public void handle(ConceptProposal cp, User creator, Date dateCreated,
			String other) {
		if (cp.getState() == null) {
