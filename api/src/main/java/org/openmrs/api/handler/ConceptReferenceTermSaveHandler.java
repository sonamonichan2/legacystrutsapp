...
/**
 * This class deals with {@link ConceptReferenceTerm} objects when they are
 * saved via a save* method in an Openmrs Service. This handler is automatically
...
public class ConceptReferenceTermSaveHandler
		implements
			SaveHandler<ConceptReferenceTerm> {

	/**
	 * Sets the concept reference term as the term A for all the
	 * {@link ConceptReferenceTermMap}s added to it.
	 * 
	 * @see org.openmrs.api.handler.RequiredDataHandler#handle(org.openmrs.OpenmrsObject,
	 *      org.openmrs.User, java.util.Date, java.lang.String)
	 */
	public void handle(ConceptReferenceTerm conceptReferenceTerm,
