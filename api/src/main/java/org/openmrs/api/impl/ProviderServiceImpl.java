...
/**
 * Default implementation of the {@link ProviderService}. This class should not
...
public class ProviderServiceImpl extends BaseOpenmrsService
	 ...
	 * getting concepts to/from the database
	 * 
	 * @param dao
	...
	/**
	 * @see org.openmrs.api.ProviderService#retireProvider(org.openmrs.Provider,
	 *      java.lang.String)
	 */
	...
	/**
	 * @see org.openmrs.api.ProviderService#getProviders(String, Integer,
	 *      Integer, java.util.Map, boolean)
	 */
	@Override
	@Transactional(readOnly = true)
	public List<Provider> getProviders(String query, Integer start,
			Integer length, Map<ProviderAttributeType, Object> attributeValues,
			boolean includeRetired) {
		Map<ProviderAttributeType, String> serializedAttributeValues = CustomDatatypeUtil
				.getValueReferences(attributeValues);
		return dao.getProviders(query, serializedAttributeValues, start,
	...
	public List<Provider> getProviders(String query, Integer start,
			Integer length, Map<ProviderAttributeType, Object> attributeValues) {
		return Context.getProviderService().getProviders(query, start, length,
	...
	public ProviderAttributeType retireProviderAttributeType(
		...
		return Context.getProviderService().saveProviderAttributeType(
	...
	public Provider getUnknownProvider() {
		return getProviderByUuid(Context.getAdministrationService()
