 ...
 * <p>
 * This is used by the PersonService. This should not be used directly, but
 * rather used through the methods on the PersonService.
 * <p>
 * Use case: <code>
...
public interface PersonDAO {
	...
	public List<Person> getPeople(String searchPhrase, Boolean dead,
			Boolean voided) throws DAOException;
	...
	public List<Relationship> getRelationships(Person fromPerson,
			...
			Date endEffectiveDate) throws DAOException;
	...
	/**
	 * Gets the value of name currently saved in the database for the given
	 * personAttributeType, bypassing any caches. This is used prior to saving
	 * an personAttributeType, so that we can change the vlaue of any global
	 * property which is in
	 * {@link OpenmrsConstants#GLOBAL_PROPERTIES_OF_PERSON_ATTRIBUTES} and
	 * reference the given personAttributeType. <br>
	 * 
	 ...
	 * 
	 * @param uuid
	 *            the UUID of the PersonMergeLog object to retrieve
