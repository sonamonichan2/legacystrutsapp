...
/**
 * Abstract class implementing basic data access methods for BaseOpenmrsData
 * persistents
 * 
 * @since 1.10
 * 
 * @param <T>
 */
public class HibernateOpenmrsDataDAO<T extends BaseOpenmrsData>
		extends
			HibernateOpenmrsObjectDAO<T> implements OpenmrsDataDAO<T> {
	...
	/**
	 * @see org.openmrs.api.db.OpenmrsDataDAO#getAll(boolean, java.lang.Integer,
	 *      java.lang.Integer)
	 */
	public List<T> getAll(boolean includeVoided, Integer firstResult,
			Integer maxResults) {
		Criteria crit = sessionFactory.getCurrentSession().createCriteria(
				mappedClass);
