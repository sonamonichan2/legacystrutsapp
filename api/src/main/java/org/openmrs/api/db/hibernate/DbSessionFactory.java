...
/**
 * It should be used instead of SessionFactory for modules, which need to
 * support OpenMRS 1.12 and before. Please do not use it, if you only need to
 * support OpenMRS 1.12 and later.
 * 
