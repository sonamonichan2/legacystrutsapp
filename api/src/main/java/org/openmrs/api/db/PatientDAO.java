...
public interface PatientDAO {
	 ...
	 * @should not get patient by mix of existing and non-existing name parts _
	 *         signature no 2
	 ...
	 * 
	 * @should not get patient by non-existing single short name _ signature no
	 *         2
	 * @should not get patient by non-existing short name parts _ signature no 2
	 * @should not get patient by mix of existing and non-existing short name
	 ...
	 * @should not get patients by searching for non-voided and voided attribute
	 *         _ signature no 2
	...
	/**
	 * @see org.openmrs.api.PatientService#getPatients(String, boolean, Integer,
	 *      Integer)
	 ...
	 * 
	 * @should return all matching non voided patient identifiers if is
	...
	public List<Patient> getDuplicatePatientsByAttributes(
			List<String> attributes) throws DAOException;
