 ...
 * data. This provides an interface for standard DAO operations on data.
 * 
 * @since 1.10
 */
public interface OpenmrsDataDAO<T extends BaseOpenmrsData>
	 ...
	 * 
	 * @param includeVoided
	 *            if true voided persistents are also returned
	 ...
	 */
	List<T> getAll(boolean includeVoided, Integer firstResult,
			Integer maxResults);
