...
public interface OrderDAO {
	...
	/**
	 * This searches for orders given the parameters. Most arguments are
	 * optional (nullable). If multiple arguments are given, the returned orders
	 * will match on all arguments. The orders are sorted by startDate with the
	 * latest coming first
	 * 
	 * @param orderType
	 ...
	 * @param orderers
	 *            The orderers to match on
	 * @param encounters
	 *            The encounters that the orders are assigned to
	 ...
	 * 
	 * @param orderType
	 *            the order type to check the usage
	 ...
	 * @param isOrderADrugOrder
	 *            is the order a previous order
