 ...
 * data. This provides an interface for standard DAO operations on metadata.
 * 
 * @since 1.10
 */
public interface OpenmrsMetadataDAO<T extends BaseOpenmrsMetadata>
	 ...
	 *            if true retired metadata is also returned
	 ...
	 */
	List<T> getAll(boolean includeRetired, Integer firstResult,
			Integer maxResults);
