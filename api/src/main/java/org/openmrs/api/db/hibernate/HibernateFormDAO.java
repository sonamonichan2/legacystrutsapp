...
/**
 * Hibernate-specific Form-related functions. This class should not be used
 * directly. All calls should go through the {@link org.openmrs.api.FormService}
 * methods.
 * 
...
public class HibernateFormDAO implements FormDAO {
	...
	/**
	 * Returns the form object originally passed in, which will have been
	 * persisted.
	 * 
	...
	public Form getForm(Integer formId) throws DAOException {
		return (Form) sessionFactory.getCurrentSession()
				.get(Form.class, formId);
	}
	...
	public List<FormField> getFormFields(Form form) throws DAOException {
		return sessionFactory.getCurrentSession()
				.createCriteria(FormField.class, "ff")
	...
	public Field getField(Integer fieldId) throws DAOException {
		return (Field) sessionFactory.getCurrentSession().get(Field.class,
				fieldId);
	}
	...
	public FieldType getFieldType(Integer fieldTypeId) throws DAOException {
		return (FieldType) sessionFactory.getCurrentSession().get(
				FieldType.class, fieldTypeId);
	}
	...
	public FormField getFormField(Integer formFieldId) throws DAOException {
		return (FormField) sessionFactory.getCurrentSession().get(
				FormField.class, formFieldId);
	}

	/**
	 * @see org.openmrs.api.FormService#getFormField(org.openmrs.Form,
	 *      org.openmrs.Concept, java.util.Collection, boolean)
	 * @see org.openmrs.api.db.FormDAO#getFormField(org.openmrs.Form,
	 *      org.openmrs.Concept, java.util.Collection, boolean)
	 */
	@SuppressWarnings("unchecked")
	public FormField getFormField(Form form, Concept concept,
		...
		Criteria crit = sessionFactory.getCurrentSession()
				...
				.add(Restrictions.eq("field.concept", concept))
		...
		String err = "FormField warning.  No FormField matching concept '"
				+ concept + "' for form '" + form + "'";
	...
	/**
	 * @see org.openmrs.api.db.FormDAO#getFields(java.util.Collection,
	...
	public List<Field> getFields(Collection<Form> forms,
		...
		if (!containsAllAnswers.isEmpty()) {
			throw new APIException("Form.getFields.error",
					new Object[]{"containsAllAnswers"});
		}

		if (!containsAnyAnswer.isEmpty()) {
			throw new APIException("Form.getFields.error",
					new Object[]{"containsAnyAnswer"});
		}
	...
	/**
	 * @see org.openmrs.api.db.FormDAO#getForm(java.lang.String,
	 *      java.lang.String)
	 */
	...
	/**
	 * @see org.openmrs.api.db.FormDAO#getForms(java.lang.String,
	...
	public List<Form> getForms(String partialName, Boolean published,
		...
		Criteria crit = getFormCriteria(partialName, published, encounterTypes,
	...
	/**
	 * @see org.openmrs.api.db.FormDAO#getFormCount(java.lang.String,
	 *      java.lang.Boolean, java.util.Collection, java.lang.Boolean,
	 *      java.util.Collection, java.util.Collection, java.util.Collection)
	 */
	...
	/**
	 * Convenience method to create the same hibernate criteria object for both
	 * getForms and getFormCount
	 * 
	 * @param partialName
	 * @param published
	...
	private Criteria getFormCriteria(String partialName, Boolean published,
		...
		if (StringUtils.isNotEmpty(partialName)) {
			crit.add(Restrictions.or(Restrictions.like("name", partialName,
		...
		// select * from form where len(containingallformfields) = (select
		// count(*) from form_field ff where ff.form_id = form_id and
		// form_field_id in (containingallformfields);
		if (!containingAllFormFields.isEmpty()) {
			...
			crit.add(Subqueries.eq(
					Long.valueOf(containingAllFormFields.size()), subquery));
		}
	...
	public Field getFieldByUuid(String uuid) {
		return (Field) sessionFactory.getCurrentSession()
				.createQuery("from Field f where f.uuid = :uuid")
				.setString("uuid", uuid).uniqueResult();
	}

	public FieldAnswer getFieldAnswerByUuid(String uuid) {
		return (FieldAnswer) sessionFactory.getCurrentSession()
				.createQuery("from FieldAnswer f where f.uuid = :uuid")
				.setString("uuid", uuid).uniqueResult();
	}
	...
	public FieldType getFieldTypeByUuid(String uuid) {
		return (FieldType) sessionFactory.getCurrentSession()
				.createQuery("from FieldType ft where ft.uuid = :uuid")
				.setString("uuid", uuid).uniqueResult();
	}
	...
	public FieldType getFieldTypeByName(String name) {
		return (FieldType) sessionFactory.getCurrentSession()
				.createQuery("from FieldType ft where ft.name = :name")
	...
	public Form getFormByUuid(String uuid) {
		return (Form) sessionFactory.getCurrentSession()
				.createQuery("from Form f where f.uuid = :uuid")
				.setString("uuid", uuid).uniqueResult();
	}
	...
	public FormField getFormFieldByUuid(String uuid) {
		return (FormField) sessionFactory.getCurrentSession()
				.createQuery("from FormField ff where ff.uuid = :uuid")
				.setString("uuid", uuid).uniqueResult();
	}
	...
	public List<FormField> getFormFieldsByField(Field field) {
		return sessionFactory.getCurrentSession()
				.createQuery("from FormField f where f.field = :field")
	...
	public FormResource getFormResource(Integer formResourceId) {
		return (FormResource) sessionFactory.getCurrentSession().get(
				FormResource.class, formResourceId);
	}
	...
	public FormResource getFormResourceByUuid(String uuid) {
		Criteria crit = sessionFactory.getCurrentSession()
				.createCriteria(FormResource.class)
				.add(Restrictions.eq("uuid", uuid));
		return (FormResource) crit.uniqueResult();
	}

	/**
	 * @see org.openmrs.api.db.FormDAO#getFormResource(org.openmrs.Form,
	 *      java.lang.String)
	 */
	@Override
	public FormResource getFormResource(Form form, String name) {
		Criteria crit = sessionFactory
				.getCurrentSession()
				.createCriteria(FormResource.class)
				.add(Restrictions.and(Restrictions.eq("form", form),
