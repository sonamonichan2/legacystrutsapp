...
/**
 * ImmutableEntityInterceptor for Obs, it catches any edited Obs, voids and
 * replaces it with a new one. I also sets the original Obs as the previous Obs
 * for the newly created one. The exceptions are when editing an already voided
 * Obs
 * 
...
public class ImmutableObsInterceptor extends ImmutableEntityInterceptor {
	...
	private static final String[] MUTABLE_PROPERTY_NAMES = new String[]{
			"voided", "dateVoided", "voidedBy", "voidReason"};
