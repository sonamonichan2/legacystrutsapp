 ...
 * of the OrderSetDAO that is used by the OrderSetService. This class is
 * injected by spring into the desired OrderSetService class. This injection is
 * determined by the xml mappings and elements in the spring application
 * context: /metadata/api/spring/applicationContext.xml.<br/>
 * <br/>
 * The OrderSetService should be used for all Order related database
 * manipulation.
 * 
...
public class HibernateOrderSetDAO implements OrderSetDAO {
	...
	protected static final Log log = LogFactory
			.getLog(HibernateOrderSetDAO.class);
	...
	public OrderSet getOrderSetById(Integer orderSetId) throws DAOException {
		return (OrderSet) sessionFactory.getCurrentSession().get(
				OrderSet.class, orderSetId);
	}
	 ...
	 */
	@Override
	public OrderSet getOrderSetByUniqueUuid(String orderSetUuid)
			throws DAOException {
		return (OrderSet) sessionFactory.getCurrentSession()
				.createQuery("from OrderSet o where o.uuid = :uuid")
	...
	public OrderSetMember getOrderSetMemberByUuid(String uuid)
		...
		return (OrderSetMember) sessionFactory.getCurrentSession()
				.createQuery("from OrderSetMember osm where osm.uuid = :uuid")
