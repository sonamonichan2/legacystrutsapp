...
public class HibernateAdministrationDAO
	...
	public GlobalProperty getGlobalPropertyObject(String propertyName) {
		if (isDatabaseStringComparisonCaseSensitive()) {
			Criteria criteria = sessionFactory.getCurrentSession()
					.createCriteria(GlobalProperty.class);
			GlobalProperty gp = (GlobalProperty) criteria.add(
					Restrictions.eq("property", propertyName).ignoreCase())
					.uniqueResult();
			return gp;
		} else {
			return (GlobalProperty) sessionFactory.getCurrentSession().get(
					GlobalProperty.class, propertyName);
		}
	}
	...
	public GlobalProperty getGlobalPropertyByUuid(String uuid)
		...
		GlobalProperty gp = (GlobalProperty) sessionFactory.getCurrentSession()
				.createQuery("from GlobalProperty t where t.uuid = :uuid")
	...
	public List<GlobalProperty> getGlobalPropertiesBySuffix(String suffix) {
		return sessionFactory.getCurrentSession()
				.createCriteria(GlobalProperty.class)
				.add(Restrictions.ilike("property", suffix, MatchMode.END))
				.list();
	}
	...
	public List<List<Object>> executeSQL(String sql, boolean selectOnly)
		...
		return DatabaseUtil.executeSQL(sessionFactory.getCurrentSession(), sql,
				selectOnly);
	}
	...
	public int getMaximumPropertyLength(Class<? extends OpenmrsObject> aClass,
		...
		if (persistentClass == null) {
			...
			int fieldLength;
			try {
				fieldLength = ((Column) persistentClass.getProperty(fieldName)
	...
	/**
	 * @see org.openmrs.api.db.AdministrationDAO#validate(java.lang.Object,
	 *      Errors)
	 */
	@Override
	...
	protected List<Validator> getValidators(Object obj) {
		...
		List<Validator> validators = HandlerUtil.getHandlersForType(
				Validator.class, obj.getClass());
	...
	public boolean isDatabaseStringComparisonCaseSensitive() {
		GlobalProperty gp = (GlobalProperty) sessionFactory
				.getCurrentSession()
				.get(GlobalProperty.class,
