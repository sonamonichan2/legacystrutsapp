...
public interface VisitDAO {
	 ...
	 *            specifies if inactive visits should be returned or not
	 * @param includeVoided
	 ...
	 * 
	 * @param previousVisit
	 *            the visit that precedes the one we are fetching
	 * @param visitTypes
	 *            a collection of visit types to match against
	 * @param maximumStartDate
	 *            the next visit should have been created before or at this date
	 *            time
	 * @return a {@link Visit}
	 * @should return the next unvoided active visit matching the specified
	 *         types and startDate
	 */
