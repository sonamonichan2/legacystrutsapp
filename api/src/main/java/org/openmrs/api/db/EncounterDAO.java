...
public interface EncounterDAO {
	...
	/**
	 * Gets the value of encounterDatetime currently saved in the database for
	 * the given encounter, bypassing any caches. This is used prior to saving
	 * an encounter so that we can change the obs if need be
	 * 
	 * @param encounter
	 *            the Encounter go the the encounterDatetime of
	 * @return the encounterDatetime currently in the database for this
	 *         encounter
	...
	/**
	 * Get a list of {@link Encounter} by Patient name or identifier based on
	 * batch settings
	 * 
	 * @param query
	...
	/**
	 * Get all enconter roles and optionally specify whehter to include retired
	 * encontered roles
	 * 
	 ...
	 */
	List<Encounter> getEncountersByVisitsAndPatient(Patient patient,
			boolean includeVoided, String query, Integer start, Integer length);

	/**
	 * @see EncounterService#getEncountersByVisitsAndPatientCount(Patient,
	 *      boolean, String)
	 */
	Integer getEncountersByVisitsAndPatientCount(Patient patient,
