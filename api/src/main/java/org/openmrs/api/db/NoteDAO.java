...
public interface NoteDAO {
	...
	/**
	 * TODO: Couldn't find a voidNote method Delete note from database. This
	 * <b>should not be called</b> except for testing and administration
	 * purposes. Use the void method instead.
	 * 
	 * @param note
	 *            <code>Note</code> to be deleted
	 * @throws DAOException
	 */
