...
public interface ConceptDAO {
	...
	/**
	 * Get a ConceptComplex. The Concept.getDatatype() is "Complex" and the
	 * Concept.getHandler() is the class name for the ComplexObsHandler key
	 * associated with this ConceptComplex.
	 * 
	 * @param conceptId
	 ...
	 *            This puts wildcard characters around the concept name search
	 *            criteria
	 * @return List&lt;Concept&gt;
	 * @throws DAOException
	 * @should not return concepts with matching names that are voided
	 */
	public List<Concept> getConcepts(String name, Locale loc,
	 ...
	 * @throws DAOException
	 * @should return correct results for concept with names that contains words
	 *         with more weight
	 * @should return correct results if a concept name contains same word more
	 *         than once
	 */
	...
	/**
	 * @param name
	 * @return the {@link ConceptDatatype} that matches <em>name</em> exactly or
	 ...
	 */
	public List<ConceptSet> getConceptSetsByConcept(Concept c)
			throws DAOException;
	 ...
	 */
	public List<ConceptProposal> getAllConceptProposals(boolean includeComplete)
			throws DAOException;
	...
	/**
	 * Gets the value of conceptDatatype currently saved in the database for the
	 * given concept, bypassing any caches. This is used prior to saving an
	 * concept so that we can change the obs if need be
	 * 
	 * @param concept
	...
	/**
	 * Gets the persisted copy of the conceptName currently saved in the
	 * database for the given conceptName, bypassing any caches. This is used
	 * prior to saving an concept so that we can change the obs if need be or
	 * avoid breaking any obs referencing it.
	 * 
	 * @param conceptName
	 *            ConceptName to fetch from the database
	 * @return the persisted copy of the conceptName currently saved in the
	 *         database for this conceptName
	 */
	...
	/**
	 * @see ConceptService#getCountOfConceptReferenceTerms(String,
	...
	/**
	 * @see ConceptService#getConceptReferenceTerms(String, ConceptSource,
	...
	/**
	 * Checks if there are any {@link ConceptReferenceTermMap}s or
	 * {@link ConceptMap}s using the specified term
	 * 
	 * @param term
	 * @return true if term is in use
	 * @throws DAOException
	 * @should return true if a term has a conceptMap or more using it
	 * @should return true if a term has a conceptReferenceTermMap or more using
	 *         it
	...
	/**
	 * Checks if there are any {@link ConceptReferenceTermMap}s or
	 * {@link ConceptMap}s using the specified mapType
	 * 
	 * @param mapType
	 * @return true if map type is in use
	 * @throws DAOException
	 * @should return true if a mapType has a conceptMap or more using it
	 * @should return true if a mapType has a conceptReferenceTermMap or more
	 *         using it
	...
	/**
	 * It is in the DAO, because it must be done in the MANUAL flush mode to
	 * prevent premature flushes in {@link ConceptService#saveConcept(Concept)}.
	 * It will be removed in 1.10 when we have a better way to manage flush
	 * modes.
	 * 
	 ...
	 */
	ConceptAttributeType saveConceptAttributeType(
