...
/**
 * Hibernate specific Provider related functions. This class should not be used
 * directly. All calls should go through the
 * {@link org.openmrs.api.ProviderService} methods.
 * 
 * @since 1.9
 */
public class HibernateProviderDAO implements ProviderDAO {
	...
	public ProviderAttribute getProviderAttribute(Integer providerAttributeID) {
		return (ProviderAttribute) getSession().load(ProviderAttribute.class,
				providerAttributeID);
	}
	...
	/**
	 * @see org.openmrs.api.db.ProviderDAO#getProviders(String, Map, Integer,
	 *      Integer, boolean)
	 */
	@Override
	...
	/**
	 * Creates or that matches the input name with Provider-Person-Names (not
	 * voided)
	 * 
	 * @param name
	 * @return Junction
	 ...
	 * 
	 * @see
	 * org.openmrs.api.db.ProviderDAO#getProviderAttributeType(java.lang.Integer
	 * )
	 */
	@Override
	public ProviderAttributeType getProviderAttributeType(
			Integer providerAttributeTypeId) {
		return (ProviderAttributeType) getSession().load(
				ProviderAttributeType.class, providerAttributeTypeId);
	}
	 ...
	 * 
	 * @see
	 * org.openmrs.api.db.ProviderDAO#getProviderAttributeTypeByUuid(java.lang
	 * .String)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.openmrs.api.db.ProviderDAO#saveProviderAttributeType(org.openmrs.
	 ...
	 * 
	 * @see
	 * org.openmrs.api.db.ProviderDAO#deleteProviderAttributeType(org.openmrs
	 * .ProviderAttributeType)
	 */
	@Override
	public void deleteProviderAttributeType(
			ProviderAttributeType providerAttributeType) {
	...
	public boolean isProviderIdentifierUnique(Provider provider)
		...
		if (provider.getProviderId() != null) {
			criteria.add(Restrictions.not(Restrictions.eq("providerId",
