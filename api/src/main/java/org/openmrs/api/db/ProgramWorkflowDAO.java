...
/**
 * Program- and PatientProgram- and ConceptStateConversion-related database
 * functions
 * 
 * @version 1.0
 */
public interface ProgramWorkflowDAO {
	 ...
	 * 
	 * @param programId
	 *            - The primary key programId to use to retrieve a
	 *            {@link Program}
	 ...
	 *            or before this Date
	 * @param includeVoided
	 *            - boolean, if true will return voided PatientPrograms as well.
	 *            If false, will not return voided PatientPrograms
	...
	public ConceptStateConversion saveConceptStateConversion(
			ConceptStateConversion csc) throws DAOException;
	 ...
	 * 
	 * @param name
	 *            the name of the Programs to retrieve.
	 * @param includeRetired
	 *            whether to include retired programs or not
	 * @should return an empty list when there is no program in the dB with
	 *         given name
