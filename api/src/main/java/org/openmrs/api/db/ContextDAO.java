...
public interface ContextDAO {
	 ...
	 * @should not authenticate given null password when password in database is
	 *         null
	 * @should not authenticate given non null password when password in
	 *         database is null
	 * @should not authenticate when password in database is empty
	 * @should give identical error messages between username and password
	 *         mismatch
	 ...
	 * @should set uuid on user property when authentication fails with valid
	 *         user
	 * @should pass regression test for 1580
	 * @should throw a ContextAuthenticationException if username is an empty
	 *         string
	...
	/**
	 * Gets a user given the uuid. Privilege checks are not done here because
	 * this is used by the {@link Context#getAuthenticatedUser()} method.
	 * 
	 * @param uuid
	 ...
	 * <p>
	 * The update is triggered if
	 * {@link OpenmrsConstants#GP_SEARCH_INDEX_VERSION} is blank or the value
