...
public class InvalidFileTypeException extends APIException {
	 ...
	 * use the {@link #InvalidFileTypeException(String)} constructor to specify
	...
	/**
	 * General constructor to give a helpful message that relates to why this
	 * error occured
	 * 
	 * @param message
	 ...
	 * @param cause
	 *            the parent exception cause that this exception is wrapping
	 *            around
	 */
