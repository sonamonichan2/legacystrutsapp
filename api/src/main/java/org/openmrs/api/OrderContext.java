...
/**
 * Contains contextual information like the OrderType, CareSetting and any other
 * custom attributes that are passed to the service layer when placing a new
 * Order E.g you could add a user defined order number from a form that can be
 * looked up from the context and returned by a custom OrderNumberGenerator
 * 
 * @since 1.10
 */
