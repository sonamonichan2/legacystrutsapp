 ...
 * <li>A CohortDefinition is a search strategy which can be used to arrive at a
 * cohort. Therefore, the patients returned by running a CohortDefinition can be
 * different depending on the data that is stored elsewhere in the database.</li>
 * </ul>
 * 
...
public interface CohortService extends OpenmrsService {
	...
	/**
	 * Save a cohort to the database (create if new, or update if changed) This
	 * method will throw an exception if any patientIds in the Cohort don't
	 * exist.
	 * 
	 * @param cohort
	...
	/**
	 * Voids the given cohort, deleting it from the perspective of the typical
	 * end user.
	 * 
	 * @param cohort
	 *            the cohort to delete
	 * @param reason
	...
	/**
	 * Returns Cohorts whose names match the given string. Returns an empty list
	 * in the case of no results. Returns all Cohorts in the case of null or
	 * empty input
	 * 
	 * @param nameFragment
	...
	/**
	 * Find all Cohorts that contain the given patient. (Not including voided
	 * Cohorts)
	 * 
	 * @param patient
	...
	/**
	 * Find all Cohorts that contain the given patientId. (Not including voided
	 * Cohorts)
	 * 
	 * @param patientId
	...
	/**
	 * Adds a new patient to a Cohort. If the patient is not already in the
	 * Cohort, then they are added, and the Cohort is saved, marking it as
	 * changed.
	 * 
	 * @param cohort
	...
	/**
	 * Removes a patient from a Cohort. If the patient is in the Cohort, then
	 * they are removed, and the Cohort is saved, marking it as changed.
	 * 
	 * @param cohort
