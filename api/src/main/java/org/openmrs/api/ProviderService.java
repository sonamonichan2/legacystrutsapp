...
public interface ProviderService extends OpenmrsService {
	...
	/**
	 * Gets all providers. includes retired Provider.This method delegates to
	 * the #getAllProviders(boolean) method
	 * 
	 ...
	 * @param includeRetired
	 * @return providers or empty collection
	 * @should return all providers by person including retired if
	 *         includeRetired is true
	 * @should return all providers by person and exclude retired if
	 ...
	 * @param attributes
	 * @param includeRetired
	 * @return the list of Providers given the query , current page and page
	 *         length
	 ...
	 * @should fetch provider by matching query string with any unVoided
	 *         PersonName's Given Name
	 * @should fetch provider by matching query string with any unVoided
	 *         PersonName's middleName
	 * @should fetch provider by matching query string with any unVoided
	 *         Person's familyName
	 * @should not fetch provider if the query string matches with any voided
	 *         Person name for that Provider
	 ...
	 */
	@Authorized({PrivilegeConstants.GET_PROVIDERS})
	public List<Provider> getProviders(String query, Integer start,
			Integer length, Map<ProviderAttributeType, Object> attributes,
			boolean includeRetired);
	...
	/**
	 * Gets the count of providers with a person name or identifier or name that
	 * matches the specified query
	 * 
	 * @param query
	 *            the text to match
	 * @param includeRetired
	 *            specifies whether retired providers should be include or not
	 * @return Count-Integer
	...
	/**
	 * Gets all provider attribute types including retired provider attribute
	 * types. This method delegates to the
	...
	/**
	 * Gets all provider attribute types optionally including retired provider
	 * attribute types.
	 * 
	 * @param includeRetired
	 *            boolean value to indicate whether to include retired records
	 *            or not
	 * @return a list of provider attribute type objects.
	 ...
	 */
	public ProviderAttributeType getProviderAttributeType(
			Integer providerAttributeTypeId);

	/**
	 * Get a provider attribute type by it's uuid
	 * 
	 * @param uuid
	 *            the uuid of the provider attribute type
	 ...
	 *            the provider attribute ID of the providerAttribute
	 ...
	 * 
	 * @param uuid
	 *            the provider attribute uuid of the providerAttribute
	 ...
	 * 
	 * @param providerAttributeType
	 *            the provider attribute type to be saved
	 ...
	 * 
	 * @param providerAttributeType
	 *            the provider type attribute to unretire
	 ...
	 */
	public void purgeProviderAttributeType(
			ProviderAttributeType providerAttributeType);
	 ...
	 * 
	 * @param provider
	 *            the provider whose identifier to check
	...
	/**
	 * Gets a provider with a matching identifier, this method performs a case
	 * insensitive search
	 * 
	 * @param identifier
	...
	/**
	 * Gets the unknown provider account, i.e. the provider account that matches
	 * the uuid specified as the value for the global property
