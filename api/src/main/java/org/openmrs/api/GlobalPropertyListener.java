...
/**
 * This interface allows code to be run when global properties are created,
 * edited, or deleted. <br>
 * TODO: Make sure listeners are notified if a global property's name is
 * changed.
 * 
...
public interface GlobalPropertyListener {
	...
	/**
	 * Asks this listener whether it wants to be notified about the given
	 * property name
	 * 
	 * @param propertyName
	 * @return whether this listener wants its action methods to be notified of
