...
/**
 * Exception thrown when a {@link Patient} or {@link PatientIdentifier} is being
 * saved with an empty or null {@link PatientIdentifier#getIdentifier()}
 * 
 * @see PatientService
...
public class BlankIdentifierException extends PatientIdentifierException {
	 ...
	 * use the {@link #BlankIdentifierException(String, PatientIdentifier)}
	 ...
	 * to why this error occurred. Preference should be given to
	 * {@link #BlankIdentifierException(String, PatientIdentifier)} over this
	 * constructor
	 * 
	 * @param message
	...
	/**
	 * This is the preferred constructor. This gives the end user both a message
	 * as to why this error occurred and the identifier which is blank.
	 * 
	 * @param message
	 *            helpful message string for the end user
	 * @param identifier
	 *            the identifier that is blank
	 */
	...
	/**
	 * Constructor used to only wrap around a parent cause. Preference should be
	 * given to the {@link #BlankIdentifierException(String, Throwable)}
