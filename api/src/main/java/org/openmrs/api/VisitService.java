...
public interface VisitService extends OpenmrsService {
	...
	/**
	 * Gets all visit types whose names are similar to or contain the given
	 * search phrase.
	 * 
	 * @param fuzzySearchPhrase
	 *            the search phrase to use.
	 * @return a list of all visit types with names similar to or containing the
	 *         given phrase
	 ...
	 * 
	 * @param visitType
	 *            the visit type to create or update.
	 ...
	 * 
	 * @param visitType
	 *            the visit type to retire.
	 * @param reason
	 *            the reason why the visit type is retired.
	...
	/**
	 * Completely removes a visit type from the database. This is not
	 * reversible.
	 * 
	 * @param visitType
	 ...
	 * @should void an attribute if max occurs is 1 and same attribute type
	 *         already exists
	 * @should save a visit though changedBy and dateCreated are not set for
	 *         VisitAttribute explicitly
	 ...
	 * 
	 * @param visit
	 *            the visit whose stopDate is to be set
	 * @param stopDate
	 *            the date and time the visit is ending. if null, current date
	 *            is used
	 ...
	 *            the visit to void.
	 * @param reason
	 *            the reason why the visit is voided
	 ...
	 * 
	 * @param visit
	 *            the visit to delete from the database.
	 * @throws APIException
	 ...
	 * @should get visits that are still open even if minStartDatetime is
	 *         specified
	 ...
	 * 
	 * @param patient
	 *            the patient whose visits to get
	 * @return a list of visits
	 * @throws APIException
	...
	/**
	 * Convenience method that delegates to getVisitsByPatient(patient, false,
	 * false)
	 * 
	 * @param patient
	 *            the patient whose visits to get
	...
	VisitAttributeType saveVisitAttributeType(
	 ...
	 */
	@Authorized(PrivilegeConstants.MANAGE_VISIT_ATTRIBUTE_TYPES)
	VisitAttributeType retireVisitAttributeType(
	 ...
	 */
	@Authorized(PrivilegeConstants.MANAGE_VISIT_ATTRIBUTE_TYPES)
	VisitAttributeType unretireVisitAttributeType(
			VisitAttributeType visitAttributeType);
	...
	/**
	 * Stops all active visits started before or on the specified date which
	 * match any of the visit types specified by the
	 * {@link OpenmrsConstants#GP_VISIT_TYPES_TO_AUTO_CLOSE} global property. If
	 * startDatetime is null, the default will be end of the current day.
	 * 
	 * @param maximumStartDate
	 *            Visits started on or before this date time value will get
	 *            stopped
	 * @should close all unvoided active visit matching the specified visit
	 *         types
	 */
	@Authorized(PrivilegeConstants.EDIT_VISITS)
