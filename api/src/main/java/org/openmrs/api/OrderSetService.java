...
public interface OrderSetService extends OpenmrsService {
	...
	/**
	 * Setter for the OrderSet data access object. The dao is used for saving
	 * and getting orders to/from the database
	 * 
	 * @param dao
	...
	/**
	 * Save or update the given <code>orderSet</code> in the database. If the
	 * OrderSet is retired it will set retired by and retired date. If
	 * OrderSetMembers are retired, it will set retired by and retired date.
	 * 
	 * @param orderSet
	...
	/**
	 * Gets all OrderSets that match the specified parameters excluding
	 * discontinuation orderSets.
	 * 
	 * @param includeRetired
	 *            Specifies whether retired orders should be included or not
	 ...
	 * 
	 * @param orderSetUuid
	 *            Specifies a saved orderSet uuid.
	 * @return an orderSet
	 * @throws APIException
	 */
	@Authorized(PrivilegeConstants.GET_ORDER_SETS)
	 ...
	 * @param retireReason
	 *            Specifies the reason why the OrderSet has to be retired
	 * @return an orderSet
	 * @throws APIException
	 */
	@Authorized({PrivilegeConstants.MANAGE_ORDER_SETS})
	OrderSet retireOrderSet(OrderSet orderSet, String retireReason)
			throws APIException;
