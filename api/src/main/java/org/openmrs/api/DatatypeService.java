...
/**
 * API methods related to {@link CustomDatatype} and
 * {@link CustomDatatypeHandler}.
 * 
 * @since 1.9
 */
public interface DatatypeService extends OpenmrsService {
	...
	/**
	 * Gets the default handler for a {@link CustomDatatype}, and sets its
	 * configuration TODO probably remove the config argument since it doesn't
	 * make sense to let people provide handlerConfig to the default handler. If
	 * we remove this argument, we also need to change
	 ...
	 */
	CustomDatatypeHandler<?, ?> getHandler(CustomDatatype<?> datatype,
