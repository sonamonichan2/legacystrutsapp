...
/**
 * A value for a user-defined {@link LocationAttributeType} that is stored on a
 * {@link Location}.
 * 
 * @see Attribute
 * @since 1.9
...
public class LocationAttribute
		extends
			BaseAttribute<LocationAttributeType, Location>
		implements
			Attribute<LocationAttributeType, Location> {

	private Integer locationAttributeId;

	// BaseAttribute<Location> has an "owner" property of type Location, which
	// we re-expose as "location"
	...
	/**
	 * @param locationAttributeId
	 *            the locationAttributeId to set
	 */
