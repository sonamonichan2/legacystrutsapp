...
public class ConceptDatatype extends BaseOpenmrsMetadata
	...
	/**
	 * @return <code>true</code> if datatype is N/A, i.e. this concept is only
	...
	/**
	 * @return <code>true</code> if datatype is coded (i.e., an identifier from
	 *         a vocabulary)
	 */
	...
	/**
	 * @return <code>true</code> if datatype is representation of date (but NOT
	 *         a time or datatime--see containsDate() and containsTime())
	 */
	...
	/**
	 * @return <code>true</code> if datatype is representation of either date or
	 *         Datetime
	 * @since 1.7
	 */
	...
	/**
	 * @return <code>true</code> if datatype is representation of either time or
	 *         Datetime
	 * @since 1.7
	 */
