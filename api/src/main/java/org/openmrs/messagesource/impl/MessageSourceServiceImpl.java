 ...
 * services. The sub-services are loaded by special BeanPostProcessor handling,
 * which looks for beans named For example: ResourceBundleMessageSourceService
 * can be specified in the applicationContext-service.xml file to use the usual
 * .properties files to provide messages.
 */
public class MessageSourceServiceImpl implements MessageSourceService {
	...
	public String getMessage(String s) {
		return Context.getMessageSourceService().getMessage(s, null,
				Context.getLocale());
	}
	 ...
	 * 
	 * @param activeMessageSource
	 *            the activeMessageSourceService to set
	 */
	...
	public String getMessage(MessageSourceResolvable resolvable, Locale locale) {
		if ((resolvable.getCodes()[0]).equals((activeMessageSource.getMessage(
				resolvable, locale)))) {
	...
	public String getMessage(String code, Object[] args, String defaultMessage,
		...
		return activeMessageSource.getMessage(code, args, defaultMessage,
				locale);
	}
	...
	/**
	 * @param availableMessageSources
	 *            the availableMessageSources to set
	 */
	...
	/**
	 * Merges messages from another message source into the active (current)
	 * message source.
	 * 
