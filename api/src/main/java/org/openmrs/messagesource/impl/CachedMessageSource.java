...
/**
 * A MutableMessageSource backed by a localized map of
 * PresentationMessageCollections, providing in-memory storage of
 * PresentationMessages. Useful for temporary storage, as a cache for other
...
public class CachedMessageSource extends AbstractMessageSource
	 ...
	 * 
	 * @see
	 * org.openmrs.messagesource.MutableMessageSource#addPresentation(org.openmrs
	 * .api.PresentationMessage)
	 */
	public void addPresentation(PresentationMessage message) {
		PresentationMessageMap codeMessageMap = localizedMap.get(message
				.getLocale());
	 ...
	 * 
	 * @see
	 * org.openmrs.messagesource.MutableMessageSource#removePresentation(org
	 * .openmrs.api.PresentationMessage)
	 */
	public void removePresentation(PresentationMessage message) {
		PresentationMessageMap codeMessageMap = localizedMap.get(message
				.getLocale());
		if ((codeMessageMap != null)
				&& codeMessageMap.containsKey(message.getCode())) {
	...
	protected MessageFormat resolveCode(String code, Locale locale) {
		...
		if (pmForCode != null) {
			resolvedMessageFormatForCode = new MessageFormat(
					pmForCode.getMessage());
		}
