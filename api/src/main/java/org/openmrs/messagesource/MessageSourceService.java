...
/**
 * Interface for a service which expands on the basic capabilities of a message
 * source.
 */
public interface MessageSourceService extends MutableMessageSource {

	/**
	 * Get the message with the given code from the current user's selected
	 * locale.
	 * 
	 ...
	 *            the <code>MutableMessageSource</code> to set
	 */
