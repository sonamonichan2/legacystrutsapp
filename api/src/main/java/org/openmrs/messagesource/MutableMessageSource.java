...
/**
 * Extended MessageSource interface, which provides more information about the
 * available messages and can be changed.
 */
public interface MutableMessageSource
	...
	/**
	 * Gets alll the available messages in a particular locale, packaged as
	 ...
	 * overwrite any existing message which conflicts (has the same code and
	 * locale).
	 * 
	 * @param message
	 *            message to add to the source
	 */
	 ...
	 * 
	 * @param fromSource
	 *            message source from which messages should be merge
	 * @param overwrite
