...
public class SimpleDosingInstructions implements DosingInstructions {
	...
	public String getDosingInstructionsAsString(Locale locale) {
		...
		if (duration != null) {
			...
			dosingInstructions.append(" ");
			dosingInstructions.append(this.durationUnits.getName(locale)
					.getName());
		}
		if (this.asNeeded) {
			dosingInstructions.append(" ");
	...
	public DosingInstructions getDosingInstructions(DrugOrder order) {
		...
		simpleDosingInstructions.setAsNeededCondition(order
				.getAsNeededCondition());
		simpleDosingInstructions.setAdministrationInstructions(order
	...
	public void validate(DrugOrder order, Errors errors) {
		ValidationUtils.rejectIfEmpty(errors, "dose",
				"DrugOrder.error.doseIsNullForDosingTypeSimple");
		ValidationUtils.rejectIfEmpty(errors, "doseUnits",
				"DrugOrder.error.doseUnitsIsNullForDosingTypeSimple");
		ValidationUtils.rejectIfEmpty(errors, "route",
				"DrugOrder.error.routeIsNullForDosingTypeSimple");
	...
	public Date getAutoExpireDate(DrugOrder drugOrder) {
		...
		return aMomentBefore(duration.addToDate(
				drugOrder.getEffectiveStartDate(), drugOrder.getFrequency()));
	}
