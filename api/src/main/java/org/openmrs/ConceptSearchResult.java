...
/**
 * An Object of this class represents a search result returned when searching
 * for concepts, it holds extra metadata about the matched concept(s).
 * 
 * @since 1.8
 */
public class ConceptSearchResult implements java.io.Serializable {
	 ...
	 */
	public ConceptSearchResult(String word, Concept concept,
	 ...
	 */
	public ConceptSearchResult(String word, Concept concept,
			ConceptName conceptName, Double transientWeight) {
		this.concept = concept;
		this.conceptName = conceptName;
		this.word = word;
