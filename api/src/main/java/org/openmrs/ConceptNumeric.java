...
/**
 * The ConceptNumeric extends upon the Concept object by adding some number
 * range values
 * 
 * @see Concept
 */
...
public class ConceptNumeric extends Concept implements java.io.Serializable {
	...
	/**
	 * displayPrecision, represents the number of significant digits to be used
	 * for display of a numeric value
	 */
	 ...
	 * @should change reference to the parent object for objects in answers
	 *         collection
	 * @should change reference to the parent object for objects in conceptSets
	 *         collection
	 * @should change reference to the parent object for objects in names
	 *         collection
	 * @should change reference to the parent object for objects in descriptions
	 *         collection
	 * @should change reference to the parent object for objects in
	 *         conceptMappings collection
	 */
	public ConceptNumeric(Concept c) {
		...
		this.setDescriptions(new HashSet<ConceptDescription>(c
				.getDescriptions()));
	...
	/**
	 * This method will <i>always</i> return true for ConceptNumeric objects
	 * that have a datatype of Numeric
	 * 
	 ...
	 *            sets displayPrecision to be used for the display of a numeric
	 *            value
	 */
