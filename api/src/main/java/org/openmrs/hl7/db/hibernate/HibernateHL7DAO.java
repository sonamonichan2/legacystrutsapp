 ...
 * shouldn't be instantiated by itself. Use the
...
public class HibernateHL7DAO implements HL7DAO {
	...
	public HL7Source getHL7Source(Integer hl7SourceId) throws DAOException {
		return (HL7Source) sessionFactory.getCurrentSession().get(
				HL7Source.class, hl7SourceId);
	}
	...
	public List<HL7InQueue> getAllHL7InQueues() throws DAOException {
		return sessionFactory
				.getCurrentSession()
				.createQuery(
						"from HL7InQueue where messageState = ? order by HL7InQueueId")
				.setParameter(0, HL7Constants.HL7_STATUS_PENDING,
	 ...
	 * @param query
	 *            string query to match against
	 * @return a Criteria object
	 */
	@SuppressWarnings("rawtypes")
	private Criteria getHL7SearchCriteria(Class clazz, Integer messageState,
		...
		if (query != null && !query.isEmpty()) {
			if (clazz == HL7InError.class) {
				crit.add(Restrictions.or(Restrictions.like("HL7Data", query,
						MatchMode.ANYWHERE), Restrictions.or(Restrictions.like(
						"errorDetails", query, MatchMode.ANYWHERE),
						Restrictions.like("error", query, MatchMode.ANYWHERE))));
			} else {
				crit.add(Restrictions
						.like("HL7Data", query, MatchMode.ANYWHERE));
			}
		}
	...
	public <T> List<T> getHL7Batch(Class clazz, int start, int length,
			Integer messageState, String query) throws DAOException {
	...
	public HL7InQueue getNextHL7InQueue() throws DAOException {
		Query query = sessionFactory
				...
				.setParameter(0, HL7Constants.HL7_STATUS_PENDING,
						StandardBasicTypes.INTEGER).setMaxResults(1);
		if (query == null) {
			return null;
		}
	...
	public List<HL7InQueue> getHL7InQueueByState(Integer state)
		...
		return sessionFactory.getCurrentSession()
				.createQuery("from HL7InQueue where messageState = ?")
	...
	public List<HL7InError> getAllHL7InErrors() throws DAOException {
		return sessionFactory.getCurrentSession()
				.createQuery("from HL7InError order by HL7InErrorId").list();
	}
	...
	public List<HL7InArchive> getHL7InArchivesToMigrate() {
		...
		Criteria crit = getHL7SearchCriteria(HL7InArchive.class,
