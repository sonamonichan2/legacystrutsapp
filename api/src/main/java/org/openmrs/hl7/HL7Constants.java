...
public class HL7Constants {
	...
	/**
	 * the key to be used for numberTransferred archives in the
	 * progressStatusMap
	 * 
	 * @since 1.7
	 */
	...
	/**
	 * time taken before static/state properties of an instance of the hl7 in
	 * archive migration thread are reset
	 * 
	 * @since 1.7
	 */
	...
	/**
	 * Assigning authority for an id for a provider in an HL7 message that
	 * specifies that it is a provider identifier
	 */
	public static final String PROVIDER_ASSIGNING_AUTH_IDENTIFIER = "PROVIDER.IDENTIFIER";

	/**
	 * Assigning authority for an id for a provider in an HL7 message that
	 * specifies that it is a provider id
	 */
	public static final String PROVIDER_ASSIGNING_AUTH_PROV_ID = "PROVIDER.ID";

	/**
	 * Assigning authority for an id for a provider in an HL7 message that
	 * specifies that it is a provider uuid
	 */
