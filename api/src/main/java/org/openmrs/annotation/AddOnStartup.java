...
/**
 * Annotation used to describe constants in the PrivilegeConstants or
 * RoleConstants class. Constant`s description or/and it`s belonging to core
 * constants can be marked with this annotation. If you want constant to be put
 * into a database at app startup, just mark it:
 * 
 * <pre>
