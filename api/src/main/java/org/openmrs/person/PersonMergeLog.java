...
/**
 * This class represents the audit of a merge of two persons. It provides as
 * much details as possible to allow potential recovery from an erroneous merge.
 * The preferred <code>Person</code> is represented by {@link #getWinner()}, the
 * non-preferred <code>Person</code> by {@link #getLoser()} and the the
 * <code>User</code> who performed the merged by {@link #getCreator()}. The
 * details of the merge is represented in XML and stored in
...
public class PersonMergeLog extends BaseOpenmrsData {
	...
	/**
	 * object representing the deserialized form of the merge data. This field
	 * is not directly mapped to the database.
	 */
