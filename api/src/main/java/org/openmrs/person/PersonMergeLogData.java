...
/**
 * This class is used for communicating to the <code>PatientService</code> the
 * data that needs to be serialized. This data represents the details of a
 * merge. It is also used for abstracting the serialization outside of the
 * PatientService and to allow storing the deserialized form of the merged data
 * 
 * @see PersonMergeLog
...
public class PersonMergeLogData {
	...
	/**
	 * List of UUIDs of observations not contained within any encounter moved
	...
	/**
	 * List of UUIDs of users moved to be associated from non-preferred to be
	 * associated to preferred
	 */
	...
	/**
	 * Value of Date of Birth of preferred person as it was before the merge
	 * occurred
	 */
	private Date priorDateOfBirth;

	/**
	 * Whether the date of birth of preferred person was an estimated value
	 * before the merge occurred
	 */
	private boolean priorDateOfBirthEstimated;

	/**
	 * Value of Date of Death of preferred person as it was before the merge
	 * occurred
	 */
	private Date priorDateOfDeath;

	/**
	 * Whether the date of death of preferred person was an estimated value
	 * before the merge occurred
	 */
	private Boolean priorDateOfDeathEstimated;

	/**
	 * Value of cause of death of preferred person as it was before the merge
	 * occurred
	 */
	...
	// public void setPriorDateOfDeathEstimated(boolean
	// priorDateOfDeathEstimated) {
	...
	public int computeHashValue() {
		...
		str += getPriorGender();
		str += (getPriorDateOfBirth() != null) ? getPriorDateOfBirth()
				.toString() : getPriorDateOfBirth();
		str += (getPriorDateOfBirth() != null) ? getPriorDateOfDeath()
				.toString() : getPriorDateOfDeath();
