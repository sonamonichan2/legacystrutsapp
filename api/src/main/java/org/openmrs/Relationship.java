...
public class Relationship extends BaseOpenmrsData
	...
	/**
	 * The purpose of this method is to allow subclasses of Relationship to
	 * delegate a portion of their copy() method back to the superclass, in case
	 * the base class implementation changes.
	 * 
	 * @param target
	 *            a Relationship that will have the state of <code>this</code>
	 *            copied into it
	...
	/**
	 * If not null, this indicates that the relationship started on a particular
	 * date
	 * 
	 * @since 1.9
	...
	/**
	 * If not null, this indicates that the relationship ended on a particular
	 * date
	 * 
	 * @since 1.9
	...
	public String toString() {
		String relType = getRelationshipType() == null
				? "NULL"
