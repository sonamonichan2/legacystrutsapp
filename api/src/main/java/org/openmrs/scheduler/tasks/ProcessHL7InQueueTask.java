...
/**
 * Implementation of a task that process all form entry queues. NOTE: This class
 * does not need to be StatefulTask as we create the context in the constructor.
 * 
 * @version 1.1 1.1 - made processor static to ensure only one HL7 processor
 *          runs
 */
