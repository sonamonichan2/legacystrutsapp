...
public interface SchedulerService extends OpenmrsService {
	 ...
	 * 
	 * @param id
	 * @return the <code>String</code> status of the task with the given
	 *         identifier
	 */
	 ...
	 * 
	 * @param task
	 *            TaskDefinition to start
	 * @return the started <code>Task</code>, or null if there was a problem
	 *         instantiating or scheduling the task
	 */
	@Authorized({"Manage Scheduler"})
	 ...
	 * 
	 * @param task
	 *            the <code>TaskDefinition</code> to reschedule
	 */
	@Authorized({"Manage Scheduler"})
	...
	/**
	 * Get the list of tasks that are available to be scheduled. Eventually,
	 * these should go in the database.
	 * 
