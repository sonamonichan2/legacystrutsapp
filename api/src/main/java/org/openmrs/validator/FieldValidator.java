...
public class FieldValidator implements Validator {
	...
	/**
	 * Validates the given Field. Ensures that the field name is present and
	 * valid
	 * 
	 * @param obj
	 ...
	 * @should pass if name is ok and fieldType, selectMultiple, and retired are
	 *         non-null
	 * @should pass validation if field lengths are correct
	 * @should fail validation if field lengths are not correct should not fail
	...
	public void validate(Object obj, Errors errors) throws APIException {
		...
		ValidateUtil.validateFieldLengths(errors, obj.getClass(), "name",
				"tableName", "attributeName", "retireReason");
	}
}
