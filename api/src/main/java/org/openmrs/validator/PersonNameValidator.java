...
public class PersonNameValidator implements Validator {
	 ...
	 * @should fail validation if PersonName.givenName is spaces surrounded by
	 *         quotation marks
	 ...
	 * @should fail validation if PersonName.familyName is spaces surrounded by
	 *         quotation marks
	 ...
	 * @should pass validation if PersonName.prefix is less than maximum field
	 *         length
	 ...
	 * @should pass validation if PersonName.givenName is less than maximum
	 *         field length
	 ...
	 * @should pass validation if PersonName.middleName is less than maximum
	 *         field length
	 * @should fail validation if PersonName.familyNamePrefix is too long
	 * @should pass validation if PersonName.familyNamePrefix is exactly max
	 *         length
	 * @should pass validation if PersonName.familyNamePrefix is less than
	 ...
	 * @should pass validation if PersonName.familyName is less than maximum
	 *         field length
	 ...
	 * @should pass validation if PersonName.familyName2 is less than maximum
	 *         field length
	 * @should fail validation if PersonName.familyNameSuffix is too long
	 * @should pass validation if PersonName.familyNameSuffix is exactly max
	 *         length
	 * @should pass validation if PersonName.familyNameSuffix is less than
	 *         maximum field length
	 * @should fail validation if PersonName.degree is too long
	 * @should pass validation if PersonName.degree is exactly max length
	 * @should pass validation if PersonName.degree is less than maximum field
	 *         length
