...
public class PatientValidator extends PersonValidator {
	...
	/**
	 * Validates the given Patient. Currently just checks for errors in
	 * identifiers. TODO: Check for errors in all Patient fields.
	 * 
	 * @param obj
	 ...
	 * @should fail validation if a preferred patient identifier is not chosen
	 *         for voided patients
	 * @should not fail when patient has only one identifier and its not
	 *         preferred
	...
	public void validate(Object obj, Errors errors) {
		...
		// Voided patients have only voided identifiers since they were voided
		// with the patient,
		// so get all otherwise get the active ones
		Collection<PatientIdentifier> identifiers = patient.isVoided()
