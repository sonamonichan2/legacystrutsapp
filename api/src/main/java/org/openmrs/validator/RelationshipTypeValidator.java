...
public class RelationshipTypeValidator implements Validator {
	 ...
	 * @should fail validation if aIsToB(or A is To B) is null or empty or
	 *         whitespace
	 * @should fail validation if bIsToA(or B is To A) is null or empty or
	 *         whitespace
	...
	public void validate(Object obj, Errors errors) {
		...
		if (relationshipType == null) {
			...
			ValidationUtils.rejectIfEmptyOrWhitespace(errors, "aIsToB",
					"RelationshipType.aIsToB.required");
			ValidationUtils.rejectIfEmptyOrWhitespace(errors, "bIsToA",
					"RelationshipType.bIsToA.required");
			ValidationUtils.rejectIfEmptyOrWhitespace(errors, "description",
					"RelationshipType.description.required");
			...
			if (exist != null
					&& !exist.isRetired()
					&& !OpenmrsUtil.nullSafeEquals(relationshipType.getUuid(),
							exist.getUuid())) {
				errors.reject("duplicate.relationshipType");
			}
			ValidateUtil.validateFieldLengths(errors, obj.getClass(), "aIsToB",
					"bIsToA", "description", "retireReason");
		}
	}
}
