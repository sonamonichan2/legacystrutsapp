...
/**
 * A concept reference term is typically name for a concept by which it is
 * referred in another institution like ICD9, ICD10, SNOMED that keeps a concept
 * dictionary or any other OpenMRS implementation
 * 
 * @since 1.9
 */
public class ConceptReferenceTerm extends BaseOpenmrsMetadata
	...
	// The unique code used to identify the reference term in it's reference
	// terminology
	 ...
	 * @param code
	 *            the code within that concept
	 * @param name
	 *            the user readable name of this term
	 * @since 1.9.2, 1.10.0
	 */
	...
	/**
	 * @param conceptReferenceTermId
	 *            the conceptReferenceTermId to set
	 */
	...
	/**
	 * @param conceptReferenceTermMaps
	 *            the conceptReferenceTermMaps to set
	 */
	public void setConceptReferenceTermMaps(
	...
	/**
	 * Add the given {@link ConceptReferenceTermMap} object to this concept
	 * reference term's list of concept reference term maps. If there is already
	 * a corresponding ConceptReferenceTermMap object for this concept reference
	 * term already, this one will not be added.
	 * 
	 ...
	 */
	public void addConceptReferenceTermMap(
			ConceptReferenceTermMap conceptReferenceTermMap) {
	...
	/**
	 * Remove the given ConceptReferenceTermMap from the list of
	 * conceptReferenceTermMaps for this {@link ConceptReferenceTerm}
	 * 
	 * @param conceptReferenceTermMap
	 * @return true if the entity was removed, false otherwise
	 */
	public boolean removeConceptReferenceTermMap(
			ConceptReferenceTermMap conceptReferenceTermMap) {
		if (conceptReferenceTermMaps != null) {
