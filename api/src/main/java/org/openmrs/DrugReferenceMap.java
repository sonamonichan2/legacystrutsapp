...
/**
 * The DrugReferenceMap map object represents a mapping between a drug and
 * alternative drug terminologies.
 * 
 * @since 1.10
 */
public class DrugReferenceMap extends BaseOpenmrsObject
		implements
			Auditable,
			Serializable {
	 ...
	 */
	public DrugReferenceMap(ConceptReferenceTerm term,
	...
	/**
	 * @param drugReferenceMapId
	 *            The drugReferenceMapId to set.
	 */
