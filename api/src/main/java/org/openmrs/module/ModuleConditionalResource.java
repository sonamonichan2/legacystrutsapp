...
public class ModuleConditionalResource {
	...
	public boolean equals(Object o) {
		...
		if (openmrsPlatformVersion != null
				? !openmrsPlatformVersion.equals(that.openmrsPlatformVersion)
	...
	public String toString() {
		return "ModuleConditionalResource{" + "path='" + path + '\''
				+ ", openmrsPlatformVersion='" + openmrsPlatformVersion + '\''
				+ ", modules=" + modules + '}';
	}
	...
	public int hashCode() {
		...
		result = 31
				* result
				+ (openmrsPlatformVersion != null ? openmrsPlatformVersion
						.hashCode() : 0);
	...
	public static class ModuleAndVersion {
		...
		@Override
		public String toString() {
			return "ModuleAndVersion{" + "moduleId='" + moduleId + '\''
					+ ", version='" + version + '\'' + '}';
		}
	}
}
