...
/**
 * This error is thrown when OpenMRS is started but there is a module that is
 * core to OpenMRS and that module is not present or did not start <br>
 * <br>
 * This error is also thrown when trying to stop a module that is marked as
 * core.
 * 
...
public class OpenmrsCoreModuleException extends ModuleMustStartException {
	...
	public OpenmrsCoreModuleException(String moduleId) {
		super(
				"The "
						+ moduleId
						+ " module is set as 'core' by OpenMRS and so cannot be stopped or unloaded.");
	}

	/**
	 * @param modules
	 *            map from module id to version that is core and didn't start
	 */
	...
	/**
	 * Helper method to turn the given modules map into a message string so that
	 * it can be passed to a super constructor
	 * 
	 * @param modules
	 *            map from module id to the version that is required
