...
public class ModuleConstants {
	...
	/**
	 * A map from "moduleid" to "required version" for all core modules that are
	 * required by openmrs. A module with at least the given version is required
	 * to start before openmrs will fully start.
	 */
	public static final Map<String, String> CORE_MODULES = new HashMap<String, String>();

	/**
	 * Used to determine if the {@link #CORE_MODULES} list should be used or
	 * not. For unit testing this is set to true to allow for faster runs with
	 * less dependencies.
	 */
	public static final String IGNORE_CORE_MODULES_PROPERTY = "module.ignore_core_status";

	/**
	 * Name of the file in the module repository to ping to question for updates
	 * to a module
	 */
	public static final String UPDATE_FILE_NAME = "update.rdf";

	/**
	 * Name of the global property that will tell the system where to look for
	 * modules to load. Can be either relative or absolute
	 */
	public static final String REPOSITORY_FOLDER_PROPERTY = "module_repository_folder";

	/**
	 * Default name of the folder that holds the currently loaded modules for
	 * the system
	 * 
	...
	/**
	 * Setting either of these properties to false will block web administration
	 * of modules
	 * 
	...
	/**
	 * Setting either of these properties to "false" will block web
	 ...
	 * specific files that need to be loaded by the Context. Should be space
	 * separated. Should be either absolute file paths or classpath loadable
	 * file paths.
	 */
	public static final String RUNTIMEPROPERTY_MODULE_LIST_TO_LOAD = "module.list_to_load";

	/**
	 * Name of the runtime property that will tell the system where to look for
	 * modules to load. Can be either relative or absolute
	 */
	public static final String REPOSITORY_FOLDER_RUNTIME_PROPERTY = "module.repository_folder";

	/**
	 * A module message.properties file containing this key mapped to "true"
	 * will be allowed to define messages outside of the module's namespace.
	 * 
	 * @since 1.9.3
	 */
