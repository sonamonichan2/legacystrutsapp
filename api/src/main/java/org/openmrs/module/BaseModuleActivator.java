...
/**
 * Must be extended by modules and referenced by the Module-Activator property
 * in the module manifest, contains methods that let modules get notifications
 * as the application is executing to allow modules to react in custom ways.
 * 
 * @since 1.7
 */
