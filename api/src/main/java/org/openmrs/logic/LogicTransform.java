...
/**
 * LogicTransform is internal representation of the transformation applied to
 * the LogicCriteria <br>
 * <br>
 * Example: <br>
 * <code>count()</code> will apply the {@link Count} operator and return the
 * total number of {@link Result} instead of the Result itself
 * <code>first(2)</code> will apply the {@link First} operator and return the
 * first two {@link Result} out of the entire Result
 */
public class LogicTransform {
	...
	/**
	 * Get number of {@link Result} object should be returned by the current
	 * criteria. <br>
	...
	/**
	 * Set number of {@link Result} object should be returned by the current
	 * criteria. <br>
	 * Only for {@link First} and {@link Last}
	 * 
	 * @param numResults
	 *            the total Result expected from this criteria
	 */
	...
	public boolean equals(Object obj) {
		...
		if (!safeEquals(this.transformOperator,
				compTransform.getTransformOperator())) {
			return false;
		}
	...
	public int hashCode() {
		...
		result = prime
				* result
				+ ((transformOperator == null) ? 0 : transformOperator
						.hashCode());
		result = prime * result
