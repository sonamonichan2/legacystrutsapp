...
/**
 * Represents a duration of time &mdash; e.g., one year, two weeks, or 18
 * months. Used within criteria. Use the
...
public class Duration implements Operand {
	 ...
	 * <code>Duration duration = Duration.days(5.0);</code> to get a duration
	 * object
	 * 
	 * @param duration
	 * @param units
