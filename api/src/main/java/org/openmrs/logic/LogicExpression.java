...
/**
 * LogicExpression is an internal representation of the LogicCriteria created
 * through LogicService. This internal representation will be processed by the
 * LogicService backend engine to create hibernate query.<br>
 * <br>
 * LogicExpression has two form, the binary and unary. Binary logic expression
...
public interface LogicExpression extends Operand {
	...
	/**
	 * Get the right operand of the LogicExpression. Both LogicExpressionBinary
	 * and LogicExpressionUnary have right operand
	 * 
