 ...
 * criteria and the newly added criteria. This class has two purposes:
 * <ol>
 ...
 * <li>
 * <code>LogicService.eval(myPatient, new LogicCriteria("CD4 COUNT"));</code></li>
 * </ul>
...
public interface LogicCriteria {
	...
	/**
	 * Create a new LogicExpression using the <code>operand</code> and
	 * <code>operator</code> and then append them to the current LogicCriteria
	 * 
	 * @param operator
	 *            one of the Operator object to be appended to the current
	 *            LogicCriteria
	 * @param operand
	 *            one of the Operand object
	 * @return a new LogicCriteria containing the existing and new
	 *         LogicExpression
	 */
	 ...
	 * 
	 * @param operator
	 *            type of the {@link TransformOperator}
	 ...
	 * 
	 * @param operator
	 *            one type of {@link Operator}
	 * @param logicCriteria
	 *            {@link LogicCriteria} to be appended
	 * @return new {@link LogicCriteria} containing existing and the new
	 *         {@link LogicCriteria}
	 */
	 ...
	 * @return LogicCriteria that is the combination of existing and the new
	 *         LogicCriteria
	 * @see And
	 */
	...
	/**
	 * Add a {@link org.openmrs.logic.op.Before} expression to the current
	 * LogicCriteria
	 * 
	 * @param value
	...
	/**
	 * Add a {@link org.openmrs.logic.op.After} expression to the current
	 * LogicCriteria
	 * 
	 * @param value
	...
	/**
	 * Add a {@link org.openmrs.logic.op.Contains} expression to the current
	 * LogicCriteria
	 * 
	 * @param value
	...
	/**
	 * Add a {@link org.openmrs.logic.op.Equals} expression to the current
	 * LogicCriteria
	 * 
	 * @param value
