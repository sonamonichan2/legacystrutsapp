...
/**
 * The Before operator works with a date object to tests whether an expression
 * will yield result before a certain date position.<br>
 * <br>
 * Example: <br>
 * -
 ...
 * observations before 12/04/2009
 * 
 * @see After
 */
