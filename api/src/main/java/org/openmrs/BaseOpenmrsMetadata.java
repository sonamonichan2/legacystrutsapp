 ...
 * Metadata represent system and descriptive data such as data types &mdash; a
 * relationship type or encounter type. Metadata are generally referenced by
 * clinical data but don't represent patient-specific data themselves. This
 * provides a default abstract implementation of the OpenmrsMetadata interface
 * 
 * @since 1.5
 * @see OpenmrsMetadata
 */
@MappedSuperclass
public abstract class BaseOpenmrsMetadata extends BaseOpenmrsObject
		implements
			OpenmrsMetadata {
	...
	/**
	 * This method delegates to {@link #isRetired()}. This is only needed for
	 * jstl syntax like ${fieldType.retired} because the return type is a
	 * Boolean object instead of a boolean primitive type.
	 * 
	 * @see org.openmrs.Retireable#isRetired()
	 */
