...
/**
 * OrderTypes are used to classify different types of Orders e.g to distinguish
 * between Serology and Radiology TestOrders
 * 
 */
public class OrderType extends BaseOpenmrsMetadata
	 ...
	 * 
	 * @param orderTypeId
	 *            the ID of the {@link org.openmrs.OrderType}
	 */
	...
	/**
	 * Convenience constructor that takes in the elements required to save this
	 * OrderType to the database
	 * 
	 * @param name
	 *            The name of this order Type
	 * @param description
	 *            A short description about this order type
	 * @param javaClassName
	...
	/**
	 * @param javaClassName
	 *            The Java class to set as String
	 */
	...
	/**
	 * @param parent
	 *            The {@link org.openmrs.OrderType} to set
	 */
	 ...
	 *            the collection containing the {@link org.openmrs.ConceptClass}
	 *            es
	 */
	...
	/**
	 * Convenience method that returns a {@link java.lang.Class} object for the
	 * associated javaClassName
	 * 
	...
	public Class getJavaClass() throws APIException {
		try {
			...
			throw new APIException("OrderType.failed.load.class",
					new Object[]{javaClassName}, e);
		}
	}
