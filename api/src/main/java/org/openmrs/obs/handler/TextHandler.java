 ...
 * "obs.complex_obs_dir" The in coming data are either char[] or java.io.Reader
 * 
 */
public class TextHandler extends AbstractHandler implements ComplexObsHandler {
	...
	private static final String[] supportedViews = {
			ComplexObsHandler.TEXT_VIEW, ComplexObsHandler.RAW_VIEW,
	...
	public Obs getObs(Obs obs, String view) {
		...
		if (ComplexObsHandler.TEXT_VIEW.equals(view)
