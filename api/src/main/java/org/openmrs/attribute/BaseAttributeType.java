...
/**
 * Abstract base implementation of {@link AttributeType}. Actual implementations
 * (e.g. VisitAttributeType, ProviderAttributeType) should be able to extend
 * this and provide very little of their own code.
 * 
 * @since 1.9
 */
@MappedSuperclass
public abstract class BaseAttributeType<OwningType extends Customizable<?>>
		extends
			BaseOpenmrsMetadata implements AttributeType<OwningType> {
