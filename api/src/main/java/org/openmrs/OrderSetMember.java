...
public class OrderSetMember extends BaseOpenmrsMetadata implements Serializable {
	...
	/**
	 * It takes in a name of a handler, which defines the schema of
	 * orderTemplate to be generated
	 * 
	 * @param orderTemplateType
	 *            the orderTemplateType to be set
	 */
