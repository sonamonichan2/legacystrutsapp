...
/**
 * A convenience builder for {@link EncounterSearchCriteria}. Create a builder,
 * set its properties to desired values and finally call
 * {@link #createEncounterSearchCriteria()} to create the actual search criteria
 * instance.
 * 
...
public class EncounterSearchCriteriaBuilder {
	...
	/**
	 * @param fromDate
	 *            the minimum date (inclusive) the encounter took place
	 * @return this builder instance
	 */
	...
	/**
	 * @param toDate
	 *            the maximum date (exclusive) the encounter took place
	 * @return this builder instance
	 */
	...
	/**
	 * @param dateChanged
	 *            the minimum date the encounter was changed
	 * @return this builder instance
	 */
	 ...
	 *            the form that entered the encounter must be in this
	 *            collection. This search parameter is omitted if the set is
	 *            null or empty.
	 * @return this builder instance
	 */
	public EncounterSearchCriteriaBuilder setEnteredViaForms(
	 ...
	 *            the type of the encounter must be in this collection. This
	...
	/**
	 * @param providers
	 *            the provider of the encounter must be in this collection. This
	 *            search parameter is omitted if the set is null or empty.
	 * @return this builder instance
	 */
	public EncounterSearchCriteriaBuilder setProviders(
	 ...
	 * @return this builder instance
	 */
	public EncounterSearchCriteriaBuilder setVisitTypes(
	...
	/**
	 * @param visits
	 *            the visits of the encounter must be in this collection. This
	 *            search parameter is omitted if the set is null or empty.
	 * @return this builder instance
	 */
	...
	/**
	 * @param includeVoided
	 *            whether to include the voided encounters or not
	 * @return this builder instance
	 */
	...
	/**
	 * Create an {@link EncounterSearchCriteria} with the properties of this
	 * builder instance.
	 * 
	 * @return a new search criteria instance
	 */
	public EncounterSearchCriteria createEncounterSearchCriteria() {
		return new EncounterSearchCriteria(patient, location, fromDate, toDate,
				dateChanged, enteredViaForms, encounterTypes, providers,
				visitTypes, visits, includeVoided);
	}
}