...
/**
 * The search parameter object for encounters. A convenience interface for
 * building instances is provided by {@link EncounterSearchCriteriaBuilder}.
 * 
 * @since 1.12
...
public class EncounterSearchCriteria {
	 ...
	 *            the form that entered this encounter must be in this
	 *            collection
	 ...
	 */
	public EncounterSearchCriteria(Patient patient, Location location,
			Date fromDate, Date toDate, Date dateChanged,
