...
public interface MessageService {
	...
	// TODO Should these be required or do we let the implementations
	// constructor dictate the dependencies?
	...
	public void sendMessage(Message message, Integer userId)
			throws MessageException;
	...
	public Message createMessage(String subject, String message)
			throws MessageException;
	...
	public Message createMessage(String recipients, String sender,
			String subject, String message) throws MessageException;
