...
public class Alert extends BaseOpenmrsObject implements Auditable, Serializable {
	...
	/**
	 * Convenience constructor to create an alert with the given text and for
	 * the given users
	 * 
	 * @param text
	 *            String to display for the alert
	 * @param users
	...
	/**
	 * Convenience method to add the given AlertRecipient to the list of
	 * recipients for this alert
	 * 
	 * @param r
	 *            AlertRecipient to add
	 */
	...
	/**
	 * Convenience method to add the given user to this list of recipients for
	 * this alert
	 * 
	 * @param u
	 *            User to add to list of recipients
	 */
	...
	/**
	 * Convenience method to remove the given AlertRecipient from this Alert's
	 * list of recipients
	 * 
	 * @param r
	 *            user to remove from list of recipients
	 */
	...
	/**
	 * Convenience method to find the AlertRecipient object within this alert
	 * that corresponds to the given <code>recipient</code>
	 * 
	 * @param recipient
	...
	/**
	 * Convenience method to mark this alert as read. In order to persist this
	 * change in the database, AlertService.saveAlert(Alert) will need to be
	 * called after this method is done.
	 * 
