...
public class Message implements Serializable {
	...
	public Message(Integer id, String recipients, String sender,
	...
	public Message(Integer id, String recipients, String sender,
			String subject, String content, String contentType,
			String attachment, String attachmentContentType,
	...
	/**
	 * Add a new receiver of this message. Will append to current list of
	 * recipients by inserting a comma. If no recipients exist, this method has
	 * no effect (TODO is this the correct behavior??!).
	 * 
	 * @param recipient
