...
/**
 * The NoteService is concerned with creating/updating/voiding and getting a
 * Note to/from the database Usage.
 */
public interface NoteService {
	 ...
	 * @return a List&lt;Note&gt; object containing all non-voided notes for the
	 *         specified user Get all Notes for a given user, Does not return
	 *         voided notes.<br>
	 */
	 ...
	 * 
	 * @param noteId
	 *            the internal primary key identifier for a Note
	 */
	...
	/**
	 * Mark a note as voided. This functionally removes the Note from the system
	 * while keeping a semblance <br>
	 * 
	 * @param note
	 *            note being voided
	 * @param reason
	 *            a reason for the the void action <br>
