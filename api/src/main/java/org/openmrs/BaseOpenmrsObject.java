...
public abstract class BaseOpenmrsObject implements Serializable, OpenmrsObject {
	 ...
	 * value <code>true</code>) or both have the same <code>uuid</code> (
	 * <code>((x.uuid != null) &amp;&amp; x.uuid.equals(y.uuid))</code> has the
	...
	public boolean equals(Object obj) {
		...
		// Need to call getUuid to make sure the hibernate proxy objects return
		// the correct uuid.
		...
		if (!(thisClass.isAssignableFrom(objClass) || objClass
	 ...
	 * <blockquote>ClassName{hashCode=..., uuid=...}</blockquote>
	 * <p>
	 * If the <code>uuid</code> field is <code>null</code>, it returns:
	 * <blockquote> ClassName{hashCode=...} </blockquote>
	 * 
