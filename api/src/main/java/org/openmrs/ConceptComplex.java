...
/**
 * Child class of Concept that has a {@link ComplexObsHandler} associated with
 * the Concept.
 * 
 * @since 1.5
 */
...
public class ConceptComplex extends Concept implements Serializable {
	...
	/**
	 * Overrides parent method and returns true if this Concept.getDatatype()
	 * equals "Complex"..
	 * 
	...
	/**
	 * @return Returns the key to the ComplexObsHandler associated with this
	 *         ConceptComplex.
	 */
