...
public class PatientIdentifierType extends BaseOpenmrsMetadata
	...
	/**
	 * Enumerates the possible ways that location may be applicable for a
	 * particular Patient Identifer Type
	 */
	...
	/**
	 * Enumeration for the way to handle uniqueness among identifiers for a
	...
	public enum UniquenessBehavior {
		...
		/**
		 * Indicates that identifiers should be unique only across a location if
		 * the identifier's location property is not null
		 */
		LOCATION
	}
	 ...
	 *            The patientIdentifierTypeId to set.
	 */
	...
	/**
	 * TODO: make this return a more debug-worth string instead of just the
	 * name. Check the webapp to make sure it is not depending on this
	 * 
