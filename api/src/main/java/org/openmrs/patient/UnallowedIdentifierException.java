...
/**
 * UnallowedIdentifierException is thrown when a class tries to process an
 * identifier given certain expectations and those expectations are not held up.
 * For example, if a class expects identifiers to consist only of numeric digits
 * and an identifier contains a non-numeric digit, this exception could be
 * thrown.
 */
