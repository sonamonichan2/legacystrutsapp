...
/**
 * Global properties are simple key-value pairs persisted in the database GPs
 * can be thought of as something similar to environment variables used in
 * operating systems.
 */
public class GlobalProperty extends BaseOpenmrsObject
		implements
			CustomValueDescriptor,
			SingleCustomValue<GlobalProperty> {
	...
	// if true, indicates that setValue has been called, and we need to invoke
	// CustomDatatype's save
	 ...
	 *            the preferredHandlerClassname to set
	 * @since 1.9
	 */
	...
	public Object getValue() throws InvalidCustomValueException {
		if (typedValue == null) {
			typedValue = CustomDatatypeUtil.getDatatypeOrDefault(this)
